...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemUserGroup : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemUserGroup()
        {
            Register();
        }


        public RepositoryItemUserGroup()
        {
            base.Buttons.Clear();
        ...
        internal const string EditorName = "acUserGroup";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acUserGroup),
                typeof(RepositoryItemUserGroup), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acUserGroup : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        static acUserGroup()
        {
            RepositoryItemUserGroup.Register();
        }
        ...
        public acUserGroup()
        {
            ...
            {
                acUserGroup.SetPopupGridView(acGridView1);
            ...
            this.GotFocus += new EventHandler(acUserGroup_GotFocus);
            this.LostFocus += new EventHandler(acUserGroup_LostFocus);
        }

        void acUserGroup_LostFocus(object sender, EventArgs e)
        {
        ...
        void acUserGroup_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        public static void SetPopupGridView(acGridView view)
        {
            ...
            view.AddTextEdit("USRGRP_CODE", "사용자 그룹코드", "42509", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            view.AddTextEdit("USRGRP_NAME", "사용자 그룹명", "42510", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acUserGroup", acInfo.DefaultConfigUser);
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemUserGroup.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemUserGroup Properties
        {
            get
            {

                return base.Properties as RepositoryItemUserGroup;
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acUserGroupForm frmFind = new acUserGroupForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["USRGRP_CODE"]))
                {
                ...
                this._Value = result.Rows[0]["USRGRP_CODE"];




                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_USRGRP_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_USRGRP_SHOW_COLUMN"));
        ...
        public static object GetCodeByName(object name)
        {
            ...
            paramTable.Columns.Add("USRGRP_NAME", typeof(String)); //부품코드

            DataRow paramRow = paramTable.NewRow();
            paramRow["PLT_CODE"] = acInfo.PLT_CODE;
            paramRow["USRGRP_NAME"] = name;
            paramTable.Rows.Add(paramRow);
            DataSet paramSet = new DataSet();
            paramSet.Tables.Add(paramTable);

            DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(),"CTRL", "CONTROL_USRGRP_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];

            if (data.Rows.Count != 0)
            {
                return data.Rows[0]["USRGRP_CODE"];
            }
        ...
        public static DataRow GetDataRow(object code)
        {
            ...
            DataTable paramTable = new DataTable("RQSTDT");
            paramTable.Columns.Add("PLT_CODE", typeof(String)); //사업장코드
            paramTable.Columns.Add("USRGRP_CODE", typeof(String)); //부품코드

            DataRow paramRow = paramTable.NewRow();
            paramRow["PLT_CODE"] = acInfo.PLT_CODE;
            paramRow["USRGRP_CODE"] = code;
            paramTable.Rows.Add(paramRow);
            DataSet paramSet = new DataSet();
            paramSet.Tables.Add(paramTable);
        ...
        private bool SetCode(object code)
        {
            ...
            if (acChecker.isNull(code) == false)
            {
                ...
                DataTable result = BizRun.QBizRun.ExecuteService(this,"CTRL", "CONTROL_USRGRP_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
