...
namespace SYS
{
    public sealed partial class SYS16A_M0A : BaseMenu
    {
        ...
        public override void MenuInit()
        {
            ...
            //acGridView1.AddLookUpEmp("APP_EMP1_OK", "승인자1", string.Empty, false, DevExpress.Utils.HorzAlignment.Center, false, false, false);
            //acGridView1.AddLookUpEmp("APP_EMP2_OK", "승인자2", string.Empty, false, DevExpress.Utils.HorzAlignment.Center, false, false, false);
            //acGridView1.AddLookUpEmp("APP_EMP3_OK", "승인자3", string.Empty, false, DevExpress.Utils.HorzAlignment.Center, false, false, false);
            //acGridView1.AddLookUpEmp("APP_EMP4_OK", "승인자4", string.Empty, false, DevExpress.Utils.HorzAlignment.Center, false, false, false);
        ...
        void Search()
        {
            ...
            BizRun.QBizRun.ExecuteService(this, QBiz.emExecuteType.NONE, "SYS16A_SER2", paramSet, "RQSTDT", "RSLTDT",
               QuickSearch,
               QuickException);
        ...
        private void acBarButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (!base.ChildFormContains(focusRow["PROPS_ID"]))
                {
                    ...
                    SYS16A_D0A frm = new SYS16A_D0A(acGridView1, focusRow);
        ...
        private void acBarButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    SYS16A_D0A frm = new SYS16A_D0A(acGridView1, null);
        ...
        private void acGroupControl2_Paint(object sender, PaintEventArgs e)
        {

        }

        private void acGridControl1_Click(object sender, EventArgs e)
        {
