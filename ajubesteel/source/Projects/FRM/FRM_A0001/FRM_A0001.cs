...
namespace REPORT
{
    public sealed partial class FRM_A0001 : acReport
    {
        public FRM_A0001()
        {
            InitializeComponent();
        ...
        public override object DataSourceProcess(object datasource)
        {
            ...
            FRM_A0001_DS newDatasource = new FRM_A0001_DS();

            FRM_A0001_DS.MRow mRow = newDatasource.M.NewMRow();
            ...
            {
                FRM_A0001_DS.DRow newRow = newDatasource.D.NewDRow();
