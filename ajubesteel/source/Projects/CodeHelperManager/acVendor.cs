...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemVendor : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemVendor()
        {
            Register();
        }


        public RepositoryItemVendor()
        {
        ...
        internal const string EditorName = "acVendor";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acVendor),
                typeof(RepositoryItemVendor), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acVendor : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        private object _VenType = null;

        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public object VenType
        {
            get { return _VenType; }
            set { _VenType = value; }
        }
        ...
        public acVendor()
        {
            ...
            if (ControlManager.acInfo.IsRunTime == true)
            {
                ...
                acVendor.SetPopupGridView(acGridView1);
            ...
            this.CloseUp += new CloseUpEventHandler(acVendor_CloseUp);

            this.Popup += new EventHandler(acVendor_Popup);

            this.QuickFindEditor.KeyDown += new KeyEventHandler(QuickFindEditor_KeyDown);

            this.GotFocus += new EventHandler(acVendor_GotFocus);
            this.LostFocus += new EventHandler(acVendor_LostFocus);
        }

        void acVendor_LostFocus(object sender, EventArgs e)
        {
        ...
        void acVendor_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        public static object GetCodeByName(object name)
        {
            ...
            paramTable.Columns.Add("VEN_NAME", typeof(String)); //부품코드

            DataRow paramRow = paramTable.NewRow();
            paramRow["PLT_CODE"] = acInfo.PLT_CODE;
            paramRow["VEN_NAME"] = name;
        ...
        public static void SetPopupGridView(acGridView view)
        {
            ...
            //기본컬럼
            view.AddTextEdit("VEN_CODE", "거래처코드", "40957", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            view.AddTextEdit("VEN_NAME", "거래처명", "40956", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);


            //옵션컬럼
            view.AddTextEdit("VEN_SHORT_NAME", "거래처약어명", "41005", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddLookUpEdit("VEN_TYPE", "거래처 형태", "6OAMFTNJ", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, "S019");

            view.AddLookUpEdit("VEN_CAT_CODE", "거래처 분류", "U48S66C9", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, "C016");

            view.AddLookUpEdit("VEN_COUNTRY", "국가", "40074", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, "S020");

            view.AddTextEdit("VEN_CEO", "대표자명", "40139", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("VEN_BIZ_NO", "사업자등록번호", "40256", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.CORP);

            view.AddTextEdit("VEN_ID_NO", "법인등록번호", "41006", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.LAW);

            view.AddDateEdit("VEN_START_DATE", "거래시작일", "40020", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emDateMask.SHORT_DATE);

            view.AddLookUpEdit("VEN_BANK", "거래은행", "40022", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, "C404");

            view.AddTextEdit("VEN_BANK_NO", "계좌번호", "E4T9XCVC", true , DevExpress.Utils.HorzAlignment.Near, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("VEN_UPTAE", "업태", "40421", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("VEN_UPJONG", "업종", "40417", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddLookUpEdit("VEN_CREDIT", "신용등급", "40396", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, "C021");

            view.AddTextEdit("VEN_ZIP", "우편번호", "40455", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.ZIP);

            view.AddTextEdit("VEN_ADDRESS", "주소", "40626", true , DevExpress.Utils.HorzAlignment.Near, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("VEN_TEL", "전화번호", "WCO6Q0OP", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.TEL);

            view.AddTextEdit("VEN_FAX", "팩스", "40713", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.TEL);

            view.AddTextEdit("VEN_EMAIL", "E-Mail", "40790", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("VEN_PRODUCTS", "취급품목", "40683", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("VEN_CHARGE_EMP", "담당자", "40127", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("VEN_CHARGE_DEPT", "담당자부서", "42377", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("VEN_CHARGE_TEL", "담당자 전화번호", "40128", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.TEL);

            view.AddTextEdit("VEN_CHARGE_HP", "담당자 휴대폰", "40129", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.TEL);

            view.AddTextEdit("SCOMMENT", "비고", "ARYZ726K", true , DevExpress.Utils.HorzAlignment.Near, false, false, false, acGridView.emTextEditMask.TEL);


        }


        void acVendor_CloseUp(object sender, CloseUpEventArgs e)
        {
            QuickFindEditor.EditValue = null;
        }

        void acVendor_Popup(object sender, EventArgs e)
        {
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acVendor", acInfo.DefaultConfigUser);
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemVendor.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemVendor Properties
        {
            get
            {

                return base.Properties as RepositoryItemVendor;
        ...
        protected override void OnClickButton(DevExpress.XtraEditors.Drawing.EditorButtonObjectInfoArgs buttonInfo)
        {
            ...
            {
                this.Execute(emMethodType.FIND, InputParameters);
            }
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acVendorForm frmFind = new acVendorForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["VEN_CODE"]))
                {
                ...
                this._Value = result.Rows[0]["VEN_CODE"];



                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_VENDOR_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_VENDOR_SHOW_COLUMN"));
        ...
        private bool SetCode(object code)
        {
            ...
            if (acChecker.isNull(code) == false)
            {
                ...
                DataTable result = BizRun.QBizRun.ExecuteService(this, "CTRL", "CONTROL_VENDOR_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
