...
namespace SYS
{
    public sealed partial class SYS12A_M0A : BaseMenu
    {
        ...
        public SYS12A_M0A()
        {
            ...
            // this.Load += SYS12A_M0A_Load;

        }
          

        //void SYS12A_M0A_Load(object sender, EventArgs e)
        //{
        //    this.Search();
        //}
        ...
        void acGridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            try
            {
                if (acGridView1.ValidFocusRowHandle() == true)
                {
                    ...
                    this.acAttachFileControl1.LinkKey = focusRow["BOARD_ID"];
                    this.acAttachFileControl1.ShowKey = new object[] { focusRow["BOARD_ID"] };
        ...
        void UpdateReader()
        {
            ...
            else 
            {
                ...
                BizRun.QBizRun.ExecuteService(this, QBiz.emExecuteType.NONE, "SYS12A_UPD", paramSet, "RQSTDT", "RSLTDT",
                QuickReader,
                QuickException);
        ...
        public override void MenuInit()
        {
            ...
            acGridView1.AddHidden("BOARD_iD", typeof(String));
           ...
           // acGridView1.AddCheckEdit("SEL", "선택", "40290", true, true, true, acGridView.emCheckEditDataType._STRING);
            ...
            acGridView1.KeyColumn = new string[] { "BOARD_ID" };
            ...
            acGridView1detail.AddHidden("BOARD_iD", typeof(String));
        ...
        void acGridView1detail_MouseDown(object sender, MouseEventArgs e)
        {
            try
            {
                if (e.Button == MouseButtons.Left && e.Clicks == 2)
                {
                    ...
                    if (focusRow != null)
                    {
                        if (!base.ChildFormContains(focusRow["BOARD_ID"]))
                        {
                            ...
                            SYS12A_D2A frm = new SYS12A_D2A(childView as acGridView, focusRow);
                ...
                if (e.Button == MouseButtons.Right)
                {
                    ...
                    _strReplyBoard_id = focusRow["BOARD_ID"].ToString();
                }
            }
            catch (Exception ex)
            {
        ...
        public void Search()
        {
            ...
            BizRun.QBizRun.ExecuteService(this, QBiz.emExecuteType.NONE, "SYS12A_SER", paramSet, "RQSTDT", "RSLTDT,RSLTDT_REPLY",
               QuickSearch,
               QuickException);
        ...
        void QuickSearch(object sender, QBiz QBiz, QBiz.ExcuteCompleteArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    acLayoutControl2.SetAllReadOnly(false);
                    acLayoutControl2.ClearValue();
                    acLayoutControl2.SetAllReadOnly(true);
                }
        ...
        private void acBarButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (!base.ChildFormContains(focusRow["BOARD_ID"]))
                {
                    ...
                    SYS12A_D0A frm = new SYS12A_D0A(acGridView1, focusRow);
            ...
            try
            {
                ...
                else
                {
                    ...
                    for (int i = 0; selectedRows.Length > i; i++)
                    {
                        ...
                        paramRow["DEL_EMP"] = acInfo.UserID;
                        paramRow["PLT_CODE"] = acInfo.PLT_CODE;
                        paramRow["BOARD_ID"] = selectedRows[i]["BOARD_ID"];
                        paramTable.Rows.Add(paramRow);
                    }
        ...
        private void acBarButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    SYS12A_D0A frm = new SYS12A_D0A(acGridView1, null);
        ...
        private void acBarButtonItem5_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                if (!base.ChildFormContains(focusRow["BOARD_ID"]))
                {
                    ...
                    SYS12A_D1A frm = new SYS12A_D1A(acGridView1, focusRow);
        ...
        private void acBarButtonItem6_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                paramRow["DEL_EMP"] = acInfo.UserID;
                paramRow["PLT_CODE"] = acInfo.PLT_CODE;
                paramRow["BOARD_ID"] = _strReplyBoard_id;
                paramTable.Rows.Add(paramRow);
                DataSet paramSet = new DataSet();
                paramSet.Tables.Add(paramTable);
