...
namespace BSTD
{
    ...
    public class STD01A
    {
        ...
        /// <returns></returns>
        public static DataSet STD01A_INS(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
                ...
                return STD01A_SER(paramDS, bizExecute);
            }
            catch (Exception ex)
            {
        ...
        /// <param name="paramDS"></param>
        /// <returns></returns>
        public static DataSet STD01A_INS2(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
                ...
                return STD01A_SER2(paramDS, bizExecute);
            }
            catch (Exception ex)
            {
                throw UTIL.SetException(ex, new System.Diagnostics.StackFrame().GetMethod().Name);
        ...
        /// <param name="paramDS"></param>
        /// <returns></returns>
        public static DataSet STD01A_INS3(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
                ...
                foreach (DataRow row in paramDS.Tables["RQSTDT"].Rows)
                {
                    ...
                    if (dtRslt.Rows.Count > 0)
                    {
                        ...
                        {
                            //공정 수정
                            DLSE.LSE_STD_PROC.LSE_STD_PROC_UPD(UTIL.GetRowToDt(row), bizExecute);
                        }
                        else
                        {
                            if (dtRslt.Rows[0]["DATA_FLAG"].Equals((byte)2))
                    ...
                    {
                        //공정 삽입
                        DLSE.LSE_STD_PROC.LSE_STD_PROC_INS(UTIL.GetRowToDt(row), bizExecute);
                ...
                return STD01A_SER3(paramDS, bizExecute);
            }
            catch (Exception ex)
            {
                throw UTIL.SetException(ex, new System.Diagnostics.StackFrame().GetMethod().Name);
        ...
        /// <returns></returns>
        public static void STD01A_UPD2(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
                UTIL.SetBizAddColumnToValue(paramDS.Tables["RQSTDT"], "PROC_TYPE", 0, typeof(Byte));
                ...
                foreach (DataRow row in paramDS.Tables["RQSTDT"].Rows)
                {
                    DataTable dt = DLSE.LSE_STD_PROC_QUERY.LSE_STD_PROC_QUERY2(UTIL.GetRowToDt(row), bizExecute);

                    if (dt.Rows.Count > 0)
                    {
                        DLSE.LSE_STD_PROC.LSE_STD_PROC_UPD2(UTIL.GetRowToDt(row), bizExecute);
                    }
                }
        ...
        /// <param name="paramDS"></param>
        /// <returns></returns>
        public static DataSet STD01A_DEL(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
                UTIL.SetBizAddColumnToValue(paramDS.Tables["RQSTDT"], "PRG_CLASS", 1, typeof(Byte));
        ...
        /// <param name="paramDS"></param>
        /// <returns></returns>
        public static DataSet STD01A_DEL2(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
                UTIL.SetBizAddColumnToValue(paramDS.Tables["RQSTDT"], "PRG_CLASS", 0, typeof(Byte));
        ...
        /// <param name="paramDS"></param>
        /// <returns></returns>
        public static DataSet STD01A_DEL3(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
                foreach(DataRow row in paramDS.Tables["RQSTDT"].Rows)
        ...
        /// <param name="paramDS"></param>
        /// <returns></returns>
        public static DataSet STD01A_DEL4(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        /// <param name="paramDS"></param>
        /// <returns></returns>
        public static DataSet STD01A_SER( DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
        ...
        /// <param name="paramDS"></param>
        /// <returns></returns>
        public static DataSet STD01A_SER2(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
        ...
        /// <param name="paramDS"></param>
        /// <returns></returns>
        public static DataSet STD01A_SER3(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            ...
            try
            {
                ...
                DataTable dtRslt = DLSE.LSE_STD_PROC_QUERY.LSE_STD_PROC_QUERY2(paramDS.Tables["RQSTDT"],  bizExecute);
        ...
        /// <param name="paramDS"></param>
        /// <returns></returns>
        public static DataSet STD01A_SER4(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
        ...
        /// <param name="paramDS"></param>
        /// <returns></returns>
        public static DataSet STD01A_SER5(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
        ...
        public static DataSet STD01A_SER6(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
                UTIL.SetBizAddColumnToValue(paramDS.Tables["RQSTDT"], "DATA_FLAG", 0, typeof(Byte));

                DataTable dtRslt = DSTD.TSTD_PROCGRP_QUERY.TSTD_PROCGRP_QUERY4(paramDS.Tables["RQSTDT"], bizExecute);
