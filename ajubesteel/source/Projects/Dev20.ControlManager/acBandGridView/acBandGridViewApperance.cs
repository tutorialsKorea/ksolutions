...
{
    [Serializable]
    public class acBandGridViewApperance : ISerializable
    {
        ...
        public acBandGridViewApperance()
        {
        ...
        public acBandGridViewApperance(SerializationInfo info, StreamingContext context)
        {
            try
            {
