...
namespace POP
{
    public partial class ChangePanel : BaseMenuDialog
    {
        ...
        public ChangePanel()
        {
            ...
            gv.AddTextEdit("PANEL_CODE", "단말기코드", "", false, DevExpress.Utils.HorzAlignment.Center, false, true, false, ControlManager.acGridView.emTextEditMask.NONE);

            gv.AddTextEdit("PANEL_NAME", "단말기명", "", false, DevExpress.Utils.HorzAlignment.Center, false, true, false, ControlManager.acGridView.emTextEditMask.NONE);
