...
{
    public sealed partial class acPOPAttachFileControl : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public acPOPAttachFileControl()
        {
            ...
            if (ControlManager.acInfo.IsRunTime == true)
            {
                ...
                FileGridView.AddCheckEdit("SEL", "선택", "40290", true, true, false, acGridView.emCheckEditDataType._STRING);

                FileGridView.AddTextEdit("UPLOAD_MENU_NAME", "", "", false, DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

                FileGridView.AddLookUpEdit("ACC_LEVEL", "공개형태", "0S83T0JI", true, DevExpress.Utils.HorzAlignment.Center, false, false, false, "S009");
                ...
                FileGridView.AddTextEdit("REG_EMP", "올린 사용자코드", "AR6EX8P8", true, DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);
                ...
                string _strPOPfontName = acInfo.SysConfig.GetSysConfigByMemory("DEFAULT_FONT");

                FileGridView.Appearance.Row.Font = new Font(_strPOPfontName, acInfo.SysConfig.GetSysConfigByMemory("DEFAULT_FONT_SIZE").toInt() + 2);
                FileGridView.Appearance.FocusedRow.Font = new Font(_strPOPfontName, acInfo.SysConfig.GetSysConfigByMemory("DEFAULT_FONT_SIZE").toInt() + 2, FontStyle.Bold);
                FileGridView.Appearance.HideSelectionRow.Font = new Font(_strPOPfontName, acInfo.SysConfig.GetSysConfigByMemory("DEFAULT_FONT_SIZE").toInt() + 2);
                FileGridView.Appearance.HeaderPanel.Font = new Font(_strPOPfontName, acInfo.SysConfig.GetSysConfigByMemory("DEFAULT_FONT_SIZE").toInt() + 2);
                FileGridView.Appearance.GroupRow.Font = new Font(_strPOPfontName, acInfo.SysConfig.GetSysConfigByMemory("DEFAULT_FONT_SIZE").toInt() + 2);

                FileGridView.RowHeight = 50;
                ...
                FileTransferGridView.Appearance.Row.Font = new Font(_strPOPfontName, acInfo.SysConfig.GetSysConfigByMemory("DEFAULT_FONT_SIZE").toInt() + 2);
                FileTransferGridView.Appearance.FocusedRow.Font = new Font(_strPOPfontName, acInfo.SysConfig.GetSysConfigByMemory("DEFAULT_FONT_SIZE").toInt() + 2, FontStyle.Bold);
                FileTransferGridView.Appearance.HideSelectionRow.Font = new Font(_strPOPfontName, acInfo.SysConfig.GetSysConfigByMemory("DEFAULT_FONT_SIZE").toInt() + 2);
                FileTransferGridView.Appearance.HeaderPanel.Font = new Font(_strPOPfontName, acInfo.SysConfig.GetSysConfigByMemory("DEFAULT_FONT_SIZE").toInt() + 2);
                FileTransferGridView.Appearance.GroupRow.Font = new Font(_strPOPfontName, acInfo.SysConfig.GetSysConfigByMemory("DEFAULT_FONT_SIZE").toInt() + 2);

                FileTransferGridView.RowHeight = 50;
