...
{
    public sealed partial class acSimpleAttachFileControl : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        {
            return "acSimpleAttachFileControl";
        }
        ...
        public acSimpleAttachFileControl()
        {
            InitializeComponent();
            ...
            if (ControlManager.acInfo.IsRunTime == true)
            {
                ...
                FileGridView.GridType = acGridView.emGridType.SEARCH;
