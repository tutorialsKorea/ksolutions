...
namespace STD
{
    public sealed partial class STD62A_M1A : BaseMenu
    {
        ...
        private readonly string CAT_CODE = "SQPIPE"; // 각관
        ...
        private void EditItem()
        {
            try
            {
                ...
                {
                    STD62A_D1A frm = new STD62A_D1A(this.CAT_CODE, acGridView2, focusRow);
        ...
        private void AddItem()
        {
            try
            {
                if (!base.ChildFormContains("NEW_CD"))
                {
                    ...
                    STD62A_D1A frm = new STD62A_D1A(this.CAT_CODE, acGridView2, null);
