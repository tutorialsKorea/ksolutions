...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemBillVendor : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemBillVendor()
        {
            Register();
        }


        public RepositoryItemBillVendor()
        {
        ...
        internal const string EditorName = "acBillVendor";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acBillVendor),
                typeof(RepositoryItemBillVendor), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acBillVendor : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        static acBillVendor()
        {
            RepositoryItemBillVendor.Register();
        }
        ...
        public acBillVendor()
        {
            ...
            if (ControlManager.acInfo.IsRunTime == true)
            {
                ...
                acBillVendor.SetPopupGridView(acGridView1);
            ...
            this.CloseUp += new CloseUpEventHandler(acBillVendor_CloseUp);

            this.Popup += new EventHandler(acBillVendor_Popup);

            this.QuickFindEditor.KeyDown += new KeyEventHandler(QuickFindEditor_KeyDown);

            this.GotFocus += new EventHandler(acBillVendor_GotFocus);
            this.LostFocus += new EventHandler(acBillVendor_LostFocus);
        }

        void acBillVendor_LostFocus(object sender, EventArgs e)
        {
        ...
        void acBillVendor_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        public static object GetCodeByName(object name)
        {
            ...
            paramRow["BVEN_NAME"] = name;
            paramTable.Rows.Add(paramRow);
            DataSet paramSet = new DataSet();
            paramSet.Tables.Add(paramTable);

            DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(), "CTRL","CONTROL_BILL_VENDOR_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];

            if (data.Rows.Count != 0)
            {
                return data.Rows[0]["BVEN_CODE"];
            }
        ...
        public static void SetPopupGridView(acGridView view)
        {
            ...
            //기본컬럼
            view.AddTextEdit("BVEN_CODE", "마감처코드", "", false, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            view.AddTextEdit("BVEN_NAME", "마감처명", "", false, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);

        }


        void acBillVendor_CloseUp(object sender, CloseUpEventArgs e)
        {
            QuickFindEditor.EditValue = null;
        }

        void acBillVendor_Popup(object sender, EventArgs e)
        {
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acBillVendor", acInfo.DefaultConfigUser);
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemBillVendor.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemBillVendor Properties
        {
            get
            {

                return base.Properties as RepositoryItemBillVendor;
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acBillVendorForm frmFind = new acBillVendorForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["BVEN_CODE"]))
                {
                ...
                this._Value = result.Rows[0]["BVEN_CODE"];



                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_BILL_VENDOR_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_BILL_VENDOR_SHOW_COLUMN"));
        ...
        public static DataRow GetDataRow(object code)
        {
            ...
            DataTable paramTable = new DataTable("RQSTDT");
            paramTable.Columns.Add("PLT_CODE", typeof(String)); //사업장코드
            paramTable.Columns.Add("BVEN_CODE", typeof(String)); //부품코드

            DataRow paramRow = paramTable.NewRow();
            paramRow["PLT_CODE"] = acInfo.PLT_CODE;
            paramRow["BVEN_CODE"] = code;
            paramTable.Rows.Add(paramRow);
            DataSet paramSet = new DataSet();
            paramSet.Tables.Add(paramTable);
        ...
        private bool SetCode(object code)
        {
            ...
            if (acChecker.isNull(code) == false)
            {
                ...
                DataTable result = BizRun.QBizRun.ExecuteService(this, "CTRL", "CONTROL_BILL_VENDOR_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
