...
namespace ORD
{
    ...
    public class RepositoryItemOneButtonEdit : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemOneButtonEdit()
        {
            Register();
        }


        public RepositoryItemOneButtonEdit()
        {
            base.Buttons.Clear();

            base.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Glyph, "등록/수정", -2, true, true, false, DevExpress.XtraEditors.ImageLocation.MiddleCenter, global::ORD.Resource.add_data_1x, new DevExpress.Utils.KeyShortcut(System.Windows.Forms.Keys.None), "", "FIND")});

            if (acInfo.IsRunTime == true)
            {
                base.Buttons[0].SuperTip = acInfo.ToolTip.GetToolTip("등록/수정");
            }

        }


        internal const string EditorName = "acOneButtonEdit";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acOneButtonEdit),
                typeof(RepositoryItemOneButtonEdit), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acOneButtonEdit : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        static acOneButtonEdit()
        {
            RepositoryItemOneButtonEdit.Register();
        }




        public acOneButtonEdit()
        {
            ...
            {
                acOneButtonEdit.SetPopupGridView(acGridView1);

            }


            acGridView1.OnInitLayout += new acGridView.InitLayoutEventHandler(acGridView1_OnInitLayout);
            this.CloseUp += new CloseUpEventHandler(acOneButtonEdit_CloseUp);
            this.Popup += new EventHandler(acOneButtonEdit_Popup);
            this.QuickFindEditor.KeyDown += new KeyEventHandler(QuickFindEditor_KeyDown);

            this.GotFocus += new EventHandler(acOneButtonEdit_GotFocus);
            this.LostFocus += new EventHandler(acOneButtonEdit_LostFocus);


        }

        void acOneButtonEdit_LostFocus(object sender, EventArgs e)
        {
        ...
        void acOneButtonEdit_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        void acOneButtonEdit_CloseUp(object sender, CloseUpEventArgs e)
        {
            QuickFindEditor.EditValue = null;
        }

        void acOneButtonEdit_Popup(object sender, EventArgs e)
        {
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acOneButtonEdit", acInfo.DefaultConfigUser);
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemOneButtonEdit.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemOneButtonEdit Properties
        {
            get
            {

                return base.Properties as RepositoryItemOneButtonEdit;
        ...
        {
            //acOneButtonEditForm frmFind = new acOneButtonEditForm();
        ...
        public static string GetAutoMarginSpec(object parCode, object spec)
        {
            ...
            try
            {
                ...
                DataRow partRow = acOneButtonEdit.GetDataRow(parCode);
