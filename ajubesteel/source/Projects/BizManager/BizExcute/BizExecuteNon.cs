...
namespace BizExecute
{
    public class BizExecuteNon
    {
        ...
        public BizExecuteNon(string serverip, string dbName)
        {
            try
            {
                ...
                connetionString = "Data Source=" + serverip + ";Initial Catalog=" + dbName + ";User ID=emes;Password=emes; Connection Timeout=5";    //192.168.10.200
