...
namespace REPORT
{
    public sealed partial class FRM_A0006 : acReport
    {
        public FRM_A0006()
        {
            InitializeComponent();
        ...
        public override object DataSourceProcess(object datasource)
        {
            ...
            FRM_A0006_DS newDatasource = new FRM_A0006_DS();

            FRM_A0006_DS.MRow mRow = newDatasource.M.NewMRow();
            ...
            {
                FRM_A0006_DS.DRow newRow = newDatasource.D.NewDRow();
