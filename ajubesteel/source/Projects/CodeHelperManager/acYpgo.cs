...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemYpgo : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemYpgo()
        {
            Register();
        }


        public RepositoryItemYpgo()
        {
            base.Buttons.Clear();
        ...
        internal const string EditorName = "acYpgo";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acYpgo),
                typeof(RepositoryItemYpgo), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acYpgo : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        public acYpgo()
        {
            ...
            if (ControlManager.acInfo.IsRunTime == true)
            {
                ...
                acYpgo.SetPopupGridView(acGridView1);
            ...
            this.GotFocus += new EventHandler(acYpgo_GotFocus);
            this.LostFocus += new EventHandler(acYpgo_LostFocus);


        }

        void acYpgo_LostFocus(object sender, EventArgs e)
        {
        ...
        void acYpgo_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        {
            //기본컬럼
            view.AddLookUpEdit("YPGO_TYPE", "구분", "41587", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, "S047");

            view.AddTextEdit("YPGO_ID", "입고번호", "42497", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acYpgo", acInfo.DefaultConfigUser);
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemYpgo.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemYpgo Properties
        {
            get
            {

                return base.Properties as RepositoryItemYpgo;
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acYpgoForm frmFind = new acYpgoForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["YPGO_ID"]))
                {
                ...
                this._Value = result.Rows[0]["YPGO_ID"];



                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_YPGO_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_YPGO_SHOW_COLUMN"));
        ...
        //    paramTable.Columns.Add("YPGO_ID", typeof(String)); //부품코드

        //    DataRow paramRow = paramTable.NewRow();
        //    paramRow["PLT_CODE"] = acInfo.PLT_CODE;
        //    paramRow["YPGO_ID"] = code;
        //    paramTable.Rows.Add(paramRow);
        //    DataSet paramSet = new DataSet();
        //    paramSet.Tables.Add(paramTable);

        //    DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(), "CONTROL_YPGO_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
