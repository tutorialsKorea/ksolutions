...
namespace DSHP
{
    public class TSHP_STOCK_LOG
    {
       
        


        public static void TSHP_STOCK_LOG_INS(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append(" INSERT INTO TSHP_STOCK_LOG ");
        ...
        public static void TSHP_STOCK_LOG_INS2(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                if (dtParam.Rows.Count > 0)
        ...
        public static void TSHP_STOCK_LOG_INS3(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                if (dtParam.Rows.Count > 0)
        ...
        public static void TSHP_STOCK_LOG_UPD(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append(" UPDATE TSHP_STOCK_LOG ");
    ...
    public class TSHP_STOCK_LOG_QUERY
    {

        public static DataTable TSHP_STOCK_LOG_QUERY1(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                ...
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append(" FROM TSHP_STOCK_LOG L JOIN LSE_STD_PART P      ");
                    ...
                    //sbQuery.Append(" AND EVENT_TIME = (SELECT MAX(EVENT_TIME) FROM TSHP_STOCK_LOG WHERE PLT_CODE = @PLT_CODE AND PART_CODE = @PART_CODE )  ");
        ...
        public static DataTable TSHP_STOCK_LOG_QUERY2(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DataSet dsResult = new DataSet();
                ...
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append(" , NEXT_AMT  ");
                    sbQuery.Append(" , REG_EMP  ");
                    sbQuery.Append(" FROM TSHP_STOCK_LOG  ");
                    sbQuery.Append(" WHERE PLT_CODE = @PLT_CODE  ");
                    sbQuery.Append(" AND PART_CODE = @PART_CODE  ");
                    sbQuery.Append(" AND STOCK_LOC = @STOCK_LOC  ");
                    sbQuery.Append(" AND EVENT_TIME = (SELECT MAX(EVENT_TIME) FROM TSHP_STOCK_LOG WHERE PLT_CODE = @PLT_CODE AND PART_CODE = @PART_CODE AND STOCK_LOC = @STOCK_LOC )  ");
        ...
        public static DataTable TSHP_STOCK_LOG_QUERY3(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DataSet dsResult = new DataSet();
        ...
        public static DataTable TSHP_STOCK_LOG_QUERY4(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DataSet dsResult = new DataSet();
        ...
        public static DataTable TSHP_STOCK_LOG_QUERY5(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DataSet dsResult = new DataSet();
                ...
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append("FROM TSHP_STOCK_LOG L 					");
        ...
        public static DataTable TSHP_STOCK_LOG_QUERY6(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DataSet dsResult = new DataSet();
