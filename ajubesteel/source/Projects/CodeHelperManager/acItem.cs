...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemItem : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemItem()
        {
            Register();
        }


        public RepositoryItemItem()
        {
            base.Buttons.Clear();
        ...
        internal const string EditorName = "acItem";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acItem),
                typeof(RepositoryItemItem), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acItem : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        public acItem()
        {
            ...
            {
                acItem.SetPopupGridView(acGridView1);
            ...
            this.GotFocus += new EventHandler(acItem_GotFocus);
            this.LostFocus += new EventHandler(acItem_LostFocus);

        }

        void acItem_LostFocus(object sender, EventArgs e)
        {
        ...
        void acItem_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        public static void SetPopupGridView(acGridView view)
        {
            ...
            //기본 컬럼
            view.AddTextEdit("ITEM_CODE", "수주코드", "40377", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("ITEM_NAME", "수주명", "41906", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);


            //옵션 컬럼
            view.AddTextEdit("CVND_CODE", "수주처코드", "FYVPQ9JZ", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("CVND_NAME", "수주처명", "42428", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddDateEdit("ORD_DATE", "수주일", "40902", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emDateMask.SHORT_DATE);

            view.AddTextEdit("BUSINESS_EMP", "영업담당자코드", "ZGBOI8X8", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("BUSINESS_EMP_NAME", "영업담당자명", "IKXJXBCK", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("PROD_CNT", "금형수", "Z4S4ERDO", true , DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.QTY);
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acItem", acInfo.DefaultConfigUser);
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemItem.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemItem Properties
        {
            get
            {

                return base.Properties as RepositoryItemItem;
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acItemForm frmFind = new acItemForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["ITEM_CODE"]))
                {
                ...
                this._Value = result.Rows[0]["ITEM_CODE"];




                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_ITEM_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_ITEM_SHOW_COLUMN"));
        ...
        public static DataRow GetDataRow(object code)
        {
            ...
            paramTable.Columns.Add("ITEM_CODE", typeof(String)); //부품코드

            DataRow paramRow = paramTable.NewRow();
            paramRow["PLT_CODE"] = acInfo.PLT_CODE;
            paramRow["ITEM_CODE"] = code;
            paramTable.Rows.Add(paramRow);
            DataSet paramSet = new DataSet();
            paramSet.Tables.Add(paramTable);

            //DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(), "CONTROL_ITEM_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];

            DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(), "CTRL", "CONTROL_ITEM_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
        ...
        private bool SetCode(object code)
        {
            ...
            if (acChecker.isNull(code) == false)
            {
                ...
                //DataTable result = BizRun.QBizRun.ExecuteService(this,"CONTROL_ITEM_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];

                DataTable result = BizRun.QBizRun.ExecuteService(GetClassName(), "CTRL", "CONTROL_ITEM_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
