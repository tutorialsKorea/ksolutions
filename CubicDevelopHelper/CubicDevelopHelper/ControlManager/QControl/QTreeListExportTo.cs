...
namespace ControlManager
{
    public class QTreeListExportTo
    {
        ...
        public enum emSaveFileType { Excel, Xlsx, PDF, RTF, Text, HTML, MHT };
    ...
    new ParameterizedThreadStart(ExecuteExportToThread));
        ...
        void ExecuteExportToThread(object args)
        {
            ...
            acTreeList sourceTreeList = new acTreeList();

            sourceTreeList = (acTreeList)param[0];
            ...
            try
            {
                ...
                //tmpTreeList.KeyFieldName = sourceTreeList.KeyFieldName;
                //tmpTreeList.ParentFieldName = sourceTreeList.ParentFieldName;
                ...
                switch (fileType)
                {
                    case emSaveFileType.Excel:
                        ...
                        sourceTreeList.ExportToXls(fileName, xlsOpt);
                        break;
                    ...
                    case emSaveFileType.Xlsx:
                        ...
                        sourceTreeList.ExportToXlsx(fileName, xlsxOpt);
                        break;
