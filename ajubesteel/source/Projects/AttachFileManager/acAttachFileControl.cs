...
{
    public sealed partial class acAttachFileControl : DevExpress.XtraEditors.XtraUserControl
    {
                    ...
                    if (this._LinkKey.isNull() == false)
                    {
                        ...
                        switch (this._AttachLinkPermission)
                        {
                            case emAttachLinkPermission.D:
                                ...
                                FileTransferGridControl.AllowDrop = false;
        ...
        public acGridView fileGridView = null;
        public acGridView fileTransferGridView = null;
        public acGridView fileDelHistoryGridView = null;

        public acAttachFileControl()
        {
            InitializeComponent();

            this.fileGridView = this.FileGridView;
            this.fileTransferGridView = this.FileTransferGridView;
            this.fileDelHistoryGridView = this.FileDelHistoryGridView;
        ...
        private bool _isMailFile = false;
        public bool IsMailFile
        {
            get { return _isMailFile; }
            set { _isMailFile = value; }
        }
        ...
        private void UpLoadMasterThreadStarter(object args)
        {
            ...
            if (row["STATE"].EqualsEx("READY"))
            {
                    ...
                    row.RowState != DataRowState.Detached)
                {
                    ...
                    if (_isMailFile)
                    {
                        DataTable fileListTable = GetFileList(LinkKey);


                        paramRow["FILE_NAME"] = _fileName + (fileListTable.Rows.Count + 1).ToString() + getExtName(fInfo.Name);
                    }
                    else
                    {
        ...
        private void btnDownload_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                acAlert.Show(this, "모두 내려받았습니다.", acAlertForm.enmType.Success);
