...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemActual : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemActual()
        {
            Register();
        }


        public RepositoryItemActual()
        {
            base.Buttons.Clear();
        ...
        internal const string EditorName = "acActual";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acActual),
                typeof(RepositoryItemActual), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    /// 실적 컨트롤
    /// </summary>
    public class acActual : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        public acActual()
        {
            ...
            {
                acActual.SetPopupGridView(acGridView1);
            }


            acGridView1.OnInitLayout += new acGridView.InitLayoutEventHandler(acGridView1_OnInitLayout);

            this.GotFocus += new EventHandler(acActual_GotFocus);

            this.LostFocus += new EventHandler(acActual_LostFocus);
        }

        void acActual_LostFocus(object sender, EventArgs e)
        {
        ...
        void acActual_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        public static void SetPopupGridView(acGridView view)
        {
            ...
            view.AddTextEdit("ACTUAL_ID", "실적번호", "ZU7TGN7X", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);

            view.AddDateEdit("WORK_DATE", "작업일", "40540", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emDateMask.SHORT_DATE);
            ...
            view.AddTextEdit("EMP_CODE", "작업자코드", "40551", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("EMP_NAME", "작업자", "40542", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acActual", acInfo.DefaultConfigUser);
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemActual.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemActual Properties
        {
            get
            {

                return base.Properties as RepositoryItemActual;
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acActualForm frmFind = new acActualForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["ACTUAL_ID"]))
                {
                ...
                this._Value = result.Rows[0]["ACTUAL_ID"];




                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_ACTUAL_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_ACTUAL_SHOW_COLUMN"));
        ...
        public static DataRow GetDataRow(object code)
        {
            ...
            paramTable.Columns.Add("ACTUAL_ID", typeof(String)); //부품코드

            DataRow paramRow = paramTable.NewRow();
            paramRow["PLT_CODE"] = acInfo.PLT_CODE;
            paramRow["ACTUAL_ID"] = code;
            paramTable.Rows.Add(paramRow);
            DataSet paramSet = new DataSet();
            paramSet.Tables.Add(paramTable);


            DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(), "CTRL", "CONTROL_ACTUAL_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
        ...
        private bool SetCode(object code)
        {
            ...
            if (acChecker.isNull(code) == false)
            {
                ...
                //DataTable result = BizRun.QBizRun.ExecuteService(this, "CONTROL_ACTUAL_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
                DataTable result = BizRun.QBizRun.ExecuteService(GetClassName(), "CTRL", "CONTROL_ACTUAL_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
                ...
                if (result.Rows.Count != 0)
                {
                    ...
                    if (!_Value.EqualsEx(result.Rows[0]["ACTUAL_ID"]))
                    {
