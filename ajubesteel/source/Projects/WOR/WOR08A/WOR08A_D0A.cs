...
namespace WOR
{
    public sealed partial class WOR08A_D0A : BaseMenuDialog
    {
        ...
        public WOR08A_D0A(acGridView linkView, object linkData, string empCode)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                if (workRows.Length == 1)
                {
                    ...
                    if (workRows[0]["IS_YESTERDAY"].ToString() == "1")
                    {
                        ...
                        */
                        if (Common.Instance.IsOnlyHoliday(endDate, nowdatetime) == false)
                        {
                            if (compDays == 1)
                            {
