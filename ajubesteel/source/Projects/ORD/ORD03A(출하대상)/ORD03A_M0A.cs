...
namespace ORD
{
    public sealed partial class ORD03A_M0A : BaseMenu
    {
        ...
        public override void MenuInit()
        {
            ...
            acGridView1.AddTextEdit("PROD_QTY", "수주수량", "", false, DevExpress.Utils.HorzAlignment.Far, false, true, false, acGridView.emTextEditMask.NUMERIC);
            acGridView1.AddTextEdit("OLD_SHIP_QTY", "출하된 수량", "", false, DevExpress.Utils.HorzAlignment.Far, false, true, false, acGridView.emTextEditMask.NUMERIC);
            acGridView1.AddTextEdit("REMAIN_QTY", "잔량", "", false, DevExpress.Utils.HorzAlignment.Far, false, true, true, acGridView.emTextEditMask.QTY);
            acGridView1.AddTextEdit("SHIP_QTY", "출하할 수량", "", false, DevExpress.Utils.HorzAlignment.Far, true, true, true, acGridView.emTextEditMask.QTY);
            ...
            acGridView1.AddTextEdit("SCOMMENT", "영업 전달사항", "", false, DevExpress.Utils.HorzAlignment.Near, false, true, false, acGridView.emTextEditMask.NONE);
        ...
        void Search()
        {
            ...
            BizRun.QBizRun.ExecuteService(
             ...
             "ORD03A_SER", paramSet, "RQSTDT", "RSLTDT",
             QuickSearch,
             QuickException);
        }
        ...
        private void btnShip_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (selectedRows.Length == 0)
            {
                //acMessageBox.Show("선택된 데이터가 없습니다.", "확인", acMessageBox.emMessageBoxType.CONFIRM);
                //return;
                selectedRows = new DataRow[1] { acGridView1.GetFocusedDataRow() };
            }

            ORD03A_D0A frm = new ORD03A_D0A(selectedRows[0]);
            frm.ParentControl = this;
            frm.ShowDialog(this);
            ...
            foreach (DataRow dr in selectedRows)
            {
                ...
                paramRow1["SHIP_PO_NO"] = outputRow["PO_NO"];
            ...
            "ORD03A_UPD", paramSet, "RQSTDT", "RSLTDT",
            QuickShip,
            QuickException);
        }
            ...
            try
            {
                ...
                foreach (DataRow row in e.result.Tables["RQSTDT"].Rows)
                {
                    ...
                    else
                    {
                        ...
                        if (rows.Length == 1) this.acGridView1.UpdateMapingRow(rows[0], true);
                    }
                }
        ...
        private void btnReturn_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            BizRun.QBizRun.ExecuteService(
            this, QBiz.emExecuteType.SAVE,
            "ORD03A_RETURN", paramSet, "RQSTDT", "RSLTDT",
            QuickShipReturn,
            QuickException);
        }
