...
namespace BSTD
{
    public class STD45A
    {
        public static DataSet STD45A_SER(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        public static DataSet STD45A_INS(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            ...
            try
            {
                ...
                return STD45A_SER(paramDS, bizExecute);
            }
            catch (Exception ex)
            {
                throw UTIL.SetException(ex, new System.Diagnostics.StackFrame().GetMethod().Name);
        ...
        public static DataSet STD45A_DEL(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
