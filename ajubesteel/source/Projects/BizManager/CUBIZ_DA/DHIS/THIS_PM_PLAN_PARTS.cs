...
namespace DHIS
{
    public class THIS_PM_PLAN_PARTS
    {
        public static DataTable THIS_PM_PLAN_PARTS_SER(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                ...
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append("  FROM THIS_PM_PLAN_PARTS       ");
        ...
        public static void THIS_PM_PLAN_PARTS_UPD(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append(" UPDATE THIS_PM_PLAN_PARTS                      ");
        ...
        /// <param name="dtParam"></param>
        /// <param name="bizExecute"></param>
        public static void THIS_PM_PLAN_PARTS_DEL(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append(" DELETE FROM  THIS_PM_PLAN_PARTS                  ");
                    sbQuery.Append("  WHERE PLT_CODE = @PLT_CODE           ");
                    sbQuery.Append("    AND MTN_CODE = @MTN_CODE             ");
                    sbQuery.Append("    AND MC_CODE = @MC_CODE             ");
                    sbQuery.Append("   AND PLAN_DATE = @PLAN_DATE      ");
        ...
        public static void THIS_PM_PLAN_PARTS_INS(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                if (dtParam.Rows.Count > 0)
                {
                    StringBuilder sbQuery = new StringBuilder();
                    sbQuery.Append(" INSERT INTO THIS_PM_PLAN_PARTS ");
                    sbQuery.Append(" (                         ");
        ...
        public static void THIS_PM_PLAN_PARTS_COPY(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                if (dtParam.Rows.Count > 0)
    ...
    public class THIS_PM_PLAN_PARTS_QUERY
    {
        /// <summary>
        /// 계측기 목록
        /// </summary>
        ...
        /// <param name="bizExecute"></param>
        /// <returns></returns>
        public static DataTable THIS_PM_PLAN_PARTS_QUERY1(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DataSet dsResult = new DataSet();
                ...
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append("  FROM THIS_PM_PLAN_PARTS PMP      ");
                    ...
                    foreach (DataRow row in dtParam.Rows)
                    {
                        ...
                        sbWhere.Append(UTIL.GetWhere(row, "@PLAN_DATE", "PMP.PLAN_DATE = @PLAN_DATE "));
                        sbWhere.Append(UTIL.GetWhere(row, "@PLN_DATE", "PMP.PLAN_DATE = @PLN_DATE "));
