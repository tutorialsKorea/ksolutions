...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemWageRate : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemWageRate()
        {
            Register();
        }


        public RepositoryItemWageRate()
        {
            base.Buttons.Clear();
        ...
        internal const string EditorName = "acWageRate";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acWageRate),
                typeof(RepositoryItemWageRate), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acWageRate : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        static acWageRate()
        {
            RepositoryItemWageRate.Register();
        }
        ...
        public acWageRate()
        {
            ...
            {
                acWageRate.SetPopupGridView(acGridView1);
            ...
            this.CloseUp += new CloseUpEventHandler(acWageRate_CloseUp);

            this.Popup += new EventHandler(acWageRate_Popup);

            this.QuickFindEditor.KeyDown += new KeyEventHandler(QuickFindEditor_KeyDown);

            this.GotFocus += new EventHandler(acWageRate_GotFocus);

            this.LostFocus += new EventHandler(acWageRate_LostFocus);
        ...
        void acWageRate_LostFocus(object sender, EventArgs e)
        {
        ...
        void acWageRate_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        void acWageRate_CloseUp(object sender, CloseUpEventArgs e)
        {
            QuickFindEditor.EditValue = null;
        }

        void acWageRate_Popup(object sender, EventArgs e)
        {
        ...
        public static void SetPopupGridView(acGridView view)
        {
            ...
            //기본컬럼
            view.AddTextEdit("UTC_CODE", "임률코드", "0BXLGNK0", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            view.AddTextEdit("UTC_NAME", "임률명", "PQB42PSL", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);


            //옵션 컬럼
            view.AddTextEdit("NOW_MON_MAN", "현재적용 월/유인임률", "8BPE3VFT", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
            view.AddTextEdit("NOW_MON_SELF", "현재적용 월/무인임률", "9F48GFGX", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
            view.AddTextEdit("NOW_MON_OT", "현재적용 월/잔업임률", "R3THH2B3", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);

            view.AddTextEdit("NOW_TUE_MAN", "현재적용 화/유인임률", "MFO4PPCA", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
            view.AddTextEdit("NOW_TUE_SELF", "현재적용 화/무인임률", "YI9AG3QL", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
            view.AddTextEdit("NOW_TUE_OT", "현재적용 화/잔업임률", "BM6842N2", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);

            view.AddTextEdit("NOW_WED_MAN", "현재적용 수/유인임률", "V8XO18BR", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
            view.AddTextEdit("NOW_WED_SELF", "현재적용 수/무인임률", "XH27INXV", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
            view.AddTextEdit("NOW_WED_OT", "현재적용 수/잔업임률", "NXT31RRW", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);

            view.AddTextEdit("NOW_THR_MAN", "현재적용 목/유인임률", "UUE5QY9L", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
            view.AddTextEdit("NOW_THR_SELF", "현재적용 목/무인임률", "EJBUH03P", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
            view.AddTextEdit("NOW_THR_OT", "현재적용 목/잔업임률", "63MYLIWG", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);

            view.AddTextEdit("NOW_FRI_MAN", "현재적용 금/유인임률", "DC61Y1D5", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
            view.AddTextEdit("NOW_FRI_SELF", "현재적용 금/무인임률", "CZ6S1M1H", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
            view.AddTextEdit("NOW_FRI_OT", "현재적용 금/잔업임률", "3RR3SRR4", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);

            view.AddTextEdit("NOW_SAT_MAN", "현재적용 토/유인임률", "S5DRH0GR", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
            view.AddTextEdit("NOW_SAT_SELF", "현재적용 토/무인임률", "GY23JU7K", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
            view.AddTextEdit("NOW_SAT_OT", "현재적용 토/잔업임률", "RM9WAPQ7", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);

            view.AddTextEdit("NOW_SUN_MAN", "현재적용 일/유인임률", "0MTXLJKM", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
            view.AddTextEdit("NOW_SUN_SELF", "현재적용 일/무인임률", "YYZ9H3DA", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
            view.AddTextEdit("NOW_SUN_OT", "현재적용 일/잔업임률", "BFK18ESN", true, DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acWageRate", acInfo.DefaultConfigUser);
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemWageRate.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemWageRate Properties
        {
            get
            {

                return base.Properties as RepositoryItemWageRate;
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acWageRateForm frmFind = new acWageRateForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["UTC_CODE"]))
                {
                ...
                this._Value = result.Rows[0]["UTC_CODE"];



                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_UTC_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_UTC_SHOW_COLUMN"));
        ...
        public static object GetCodeByName(object name)
        {
            ...
            paramTable.Columns.Add("UTC_NAME", typeof(String)); //부품코드

            DataRow paramRow = paramTable.NewRow();
            paramRow["PLT_CODE"] = acInfo.PLT_CODE;
            paramRow["UTC_NAME"] = name;
        ...
        public static DataRow GetDataRow(object code)
        {
            ...
            DataTable paramTable = new DataTable("RQSTDT");
            paramTable.Columns.Add("PLT_CODE", typeof(String)); //사업장코드
            paramTable.Columns.Add("UTC_CODE", typeof(String)); //부품코드

            DataRow paramRow = paramTable.NewRow();
            paramRow["PLT_CODE"] = acInfo.PLT_CODE;
            paramRow["UTC_CODE"] = code;
            paramTable.Rows.Add(paramRow);
            DataSet paramSet = new DataSet();
            paramSet.Tables.Add(paramTable);
        ...
        private bool SetCode(object code)
        {
            ...
            if (acChecker.isNull(code) == false)
            {
                ...
                DataTable result = BizRun.QBizRun.ExecuteService(this, "CTRL", "CONTROL_WAGERATE_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
