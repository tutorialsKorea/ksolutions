...
namespace BPLN
{
    ...
    {
        //품목 정보 가져오기(트리)
        public static DataSet PLN01B_SER(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
        ...
        public static DataSet PLN01B_SER2(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
        ...
        /// <returns></returns>
        public static DataSet PLN01B_SER6(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
        ...
        //품목공정 정보 저장
        public static DataSet PLN01B_SAVE(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            ...
            try
            {
                ...
                DLSE.LSE_STD_PARTPROC_VIRTUAL.LSE_STD_PARTPROC_VIRTUAL_DEL(dtRqst_Copy, bizExecute);

                DLSE.LSE_STD_PARTPROC_VIRTUAL.LSE_STD_PARTPROC_VIRTUAL_INS(paramDS.Tables["RQSTDT"], bizExecute);

                //가공비 UPDATE
                DataTable dtproc = DLSE.LSE_STD_PARTPROC_VIRTUAL_QUERY.LSE_STD_PARTPROC_VIRTUAL_QUERY4(paramDS.Tables["RQSTDT"], bizExecute);
                ...
                DataTable dtRslt = DLSE.LSE_STD_PARTPROC_VIRTUAL.LSE_STD_PARTPROC_VIRTUAL_SER2(dtRqst_Copy, bizExecute);
        ...
        /// <param name="bizExecute"></param>
        /// <returns></returns>
        public static DataSet PLN01B_SAVE2(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
                if (paramDS.Tables["RQSTDT"].Rows.Count == 0)
        ...
        /// <param name="bizExecute"></param>
        /// <returns></returns>
        public static void PLN01B_SAVE3(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        public static DataSet PLN01B_SAVE4(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        /// <param name="bizExecute"></param>
        /// <returns></returns>
        public static void PLN01B_SAVE5(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        /// <param name="paramDS"></param>
        /// <param name="bizExecute"></param>
        public static void PLN01B_SAVE6(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        /// <param name="paramDS"></param>
        /// <param name="bizExecute"></param>
        public static void PLN01B_SAVE7(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        /// <param name="paramDS"></param>
        /// <param name="bizExecute"></param>
        public static void PLN01B_SAVE8(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        public static void PLN01B_MC_SAVE(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DAPS.APS_STD_AVAILMC_PART.APS_STD_AVAILMC_PART_DEL(paramDS.Tables["RQSTDT"], bizExecute);
        ...
        /// <param name="bizExecute"></param>
        /// <returns></returns>
        public static DataSet PLN01B_INS(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
                ...
                return PLN01B_SER8(paramDS, bizExecute);
            }
            catch (Exception ex)
            {
                throw UTIL.SetException(ex, new System.Diagnostics.StackFrame().GetMethod().Name);
        ...
        /// <param name="bizExecute"></param>
        /// <returns></returns>
        public static DataSet PLN01B_INS2(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        /// <param name="bizExecute"></param>
        /// <returns></returns>
        public static DataSet PLN01B_INS3(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        public static DataSet PLN01B_INS4(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        public static DataSet PLN01B_INS5(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        public static DataSet PLN01B_INS6(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        /// <param name="bizExecute"></param>
        /// <returns></returns>
        public static DataSet PLN01B_SER3(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        /// <param name="bizExecute"></param>
        /// <returns></returns>
        public static DataSet PLN01B_DEL(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        /// <param name="bizExecute"></param>
        /// <returns></returns>
        public static DataSet PLN01B_SER4(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        public static DataSet PLN01B_SER5(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
        ...
        public static DataSet PLN01B_SER7(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
                UTIL.SetBizAddColumnToValue(paramDS.Tables["RQSTDT"], "DATA_FLAG", 0, typeof(Byte));
        ...
        public static DataSet PLN01B_SER8(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
        ...
        public static DataSet PLN01B_SER9(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
        ...
        public static DataSet PLN01B_SER_STD(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
        ...
        public static DataSet PLN01B_SER_STD2(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {

            try
            {
                //공정 정보
                DataTable dtRslt = DLSE.LSE_STD_PARTPROC_VIRTUAL_QUERY.LSE_STD_PARTPROC_VIRTUAL_QUERY3(paramDS.Tables["RQSTDT"], bizExecute);
        ...
        public static DataSet PLN01B_SER10(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {

            try
            {
                DataTable dtRslt = DLSE.LSE_STD_PARTPROC.LSE_STD_PARTPROC_SER4(paramDS.Tables["RQSTDT"], bizExecute);
                dtRslt.TableName = "RSLTDT";
