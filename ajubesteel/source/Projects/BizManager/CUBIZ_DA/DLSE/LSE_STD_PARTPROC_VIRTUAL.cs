...
namespace DLSE
{
    public class LSE_STD_PARTPROC_VIRTUAL
    {
        public static DataTable LSE_STD_PARTPROC_VIRTUAL_SER(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                ...
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append(" FROM LSE_STD_PARTPROC_VIRTUAL ");
        ...
        public static DataTable LSE_STD_PARTPROC_VIRTUAL_SER2(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DataSet dsResult = new DataSet();
                ...
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append(" FROM LSE_STD_PARTPROC_VIRTUAL PP LEFT JOIN LSE_MACHINE M");
        ...
        public static DataTable LSE_STD_PARTPROC_VIRTUAL_SER3(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DataSet dsResult = new DataSet();
        ...
        public static DataTable LSE_STD_PARTPROC_VIRTUAL_SER4(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DataSet dsResult = new DataSet();
        ...
        public static void LSE_STD_PARTPROC_VIRTUAL_DEL(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                if (dtParam.Rows.Count > 0)
                {
                    StringBuilder sbQuery = new StringBuilder();
                    sbQuery.Append(" DELETE FROM LSE_STD_PARTPROC_VIRTUAL ");                    
                    sbQuery.Append(" WHERE PLT_CODE = @PLT_CODE");
                    sbQuery.Append(" AND PART_CODE = @PART_CODE");
        ...
        public static void LSE_STD_PARTPROC_VIRTUAL_INS(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append(" INSERT INTO LSE_STD_PARTPROC_VIRTUAL");
                    sbQuery.Append(" ( ");
        ...
        public static void LSE_STD_PARTPROC_VIRTUAL_INS2(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                if (dtParam.Rows.Count > 0)
        ...
        public static void LSE_STD_PARTPROC_VIRTUAL_UPD(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append(" UPDATE  LSE_STD_PARTPROC_VIRTUAL SET");
        ...
        public static void LSE_STD_PARTPROC_VIRTUAL_UPD2(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                if (dtParam.Rows.Count > 0)
        ...
        public static void LSE_STD_PARTPROC_VIRTUAL_UPD3(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                if (dtParam.Rows.Count > 0)
                {
                    StringBuilder sbQuery = new StringBuilder();
                    sbQuery.Append(" UPDATE LSE_STD_PARTPROC_VIRTUAL");
    ...
    public class LSE_STD_PARTPROC_VIRTUAL_QUERY
    {
        //품목 별 공정 정보
        public static DataTable LSE_STD_PARTPROC_VIRTUAL_QUERY1(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DataSet dsResult = new DataSet();
                ...
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow row in dtParam.Rows)
                    {
                        ...
                        sbWhere.Append(UTIL.GetWhere(row, "@MAT_LTYPE", "MAT_LTYPE = @MAT_LTYPE"));
                        sbWhere.Append(UTIL.GetWhere(row, "@MAT_MTYPE", "MAT_MTYPE = @MAT_MTYPEE"));
                        sbWhere.Append(UTIL.GetWhere(row, "@MAT_STYPE", "MAT_STYPE = @MAT_STYPE"));
                        sbWhere.Append(UTIL.GetWhere(row, "@MAT_QLTY", "MAT_QLTY = @MAT_QLTY"));
                        sbWhere.Append(UTIL.GetWhere(row, "@PART_LIKE", "(PART_CODE LIKE '%' + @PART_LIKE + '%' OR PART_NAME LIKE '%' + @PART_LIKE + '%')"));
                        sbWhere.Append(UTIL.GetWhere(row, "@SPEC_LIKE", "(MAT_SPEC LIKE '%' + @SPEC_LIKE + '%' OR MAT_SPEC1 LIKE '%' + @SPEC_LIKE + '%')"));
                        sbWhere.Append(UTIL.GetWhere(row, "@AUTO_CREATE", "AUTO_CREATE = @AUTO_CREATE"));
        ...
        //부품별 공정
        public static DataTable LSE_STD_PARTPROC_VIRTUAL_QUERY2(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DataSet dsResult = new DataSet();
                ...
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append("  FROM LSE_STD_PARTPROC_VIRTUAL P ");
        ...
        public static DataTable LSE_STD_PARTPROC_VIRTUAL_QUERY2_1(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DataSet dsResult = new DataSet();
        ...
        public static DataTable  LSE_STD_PARTPROC_VIRTUAL_QUERY3(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DataSet dsResult = new DataSet();
                ...
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append("  LEFT OUTER JOIN LSE_STD_PARTPROC_VIRTUAL SPP ");
                    ...
                    sbQuery.Append("   AND SP.IS_ASSY = 1 ");
        ...
        public static DataTable LSE_STD_PARTPROC_VIRTUAL_QUERY4(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DataSet dsResult = new DataSet();
                ...
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append(" SELECT PP.PLT_CODE, PP.PART_CODE, SUM(ISNULL(PP.PROC_COST, 0)) + ISNULL(P.JIG_COST,0) + ISNULL(P.ETC_COST,0) AS PROC_COST FROM LSE_STD_PARTPROC_VIRTUAL  PP ");
        ...
        public static DataTable LSE_STD_PARTPROC_VIRTUAL_QUERY5(DataTable dtParam, BizExecute.BizExecute bizExecute)
        {
            try
            {
                DataSet dsResult = new DataSet();
                ...
                if (dtParam.Rows.Count > 0)
                {
                    ...
                    sbQuery.Append(" 	 , PP.PROC_UC											   ");
                    sbQuery.Append(" 	 , P.IS_OS											   ");
                    sbQuery.Append("   FROM LSE_STD_PARTPROC_VIRTUAL PP									   ");
