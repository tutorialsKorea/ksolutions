    ...
    public class acMailImplicitSSL
    {
        ...
        public bool SendEmail(object sender, string subject)
        {
            ...
            try
            {
                ...
                smtp.Connect(acInfo.SysConfig.GetSysConfigByMemory("SMTP_ADDRESS"), acInfo.SysConfig.GetSysConfigByMemory("SMTP_PORT").toInt(), SecureSocketOptions.SslOnConnect);
