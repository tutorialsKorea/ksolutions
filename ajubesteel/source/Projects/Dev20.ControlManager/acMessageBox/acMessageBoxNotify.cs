...
namespace ControlManager
{
    ...
    /// </summary>
    public partial class acMessageBoxNotify : DevExpress.XtraEditors.XtraForm
    {
        ...
        public event System.EventHandler NotifyClose;
        ...
        public acMessageBoxNotify(object title, object text)
            : this()
        {
            Title = title.toStringNull();
            Text = text.toStringNull();
        }

        public acMessageBoxNotify(object text)
            : this() 
        {
            Title = string.Format("{0} - {1}", acInfo.SystemName, acInfo.PLT_NAME);
            Text = text.toStringNull();
        }

        public acMessageBoxNotify()
        {
            ...
            WaitTime = acInfo.EmpConfig.GetEmpConfigByMemory("NOTIFY_POPUP_TIME").toInt() * 1000;
        }
        #endregion
        ...
        public void Notify()
        {
            ...
            if (TitleHoverFont == null)
                TitleHoverFont = new Font(TitleFont, TitleFont.Style);
        ...
        {
            fx.DrawRectangle(Pens.Silver, 0, 0, Width, ActualHeight);
        ...
        protected void drawThemeCloseButton(Graphics fx)
        {
            ...
            DrawThemeBackground(hTheme, hDC, 19, stateId, ref reClose, ref reClip);
            ...
            switch (ClockState)
            {
                ...
                case ClockStates.Closing:
                    ...
                    if (Top >= rScreen.Height)
                    {
                        ...
                        if (NotifyClose != null)
                        {
                            NotifyClose(this, new System.EventArgs());
                        }
