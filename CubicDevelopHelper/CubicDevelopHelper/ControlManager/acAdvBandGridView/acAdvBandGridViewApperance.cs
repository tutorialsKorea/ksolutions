...
{
    [Serializable]
    public class acAdvBandGridViewApperance : ISerializable
    {
        ...
        public acAdvBandGridViewApperance()
        {
        ...
        public acAdvBandGridViewApperance(SerializationInfo info, StreamingContext context)
        {
            try
            {
