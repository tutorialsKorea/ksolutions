...
{
    public class acBandedGridColumnCollection : BandedGridColumnCollection
    {
        public acBandedGridColumnCollection(ColumnView view) : base(view) { }

        protected override GridColumn CreateColumn()
        {
            BandedGridColumn dd = new BandedGridColumn();

            return new acBandedGridColumn();
        }
    }


    public class acBandedGridColumn : BandedGridColumn, IBaseViewControl
    {


        public acBandedGridColumn()
            : base()
        {
        ...
        public bool Check()
        {
            switch (this._EditorType)
            {
                ...
                case acBandGridView.emEditorType.NONE:
                    {
                        return true;
                ...
                case acBandGridView.emEditorType.BUTTON:
                    {
                ...
                case acBandGridView.emEditorType.COLOR:
                    {
                        return true;
                ...
                case acBandGridView.emEditorType.CUSTOM:
                    {
                        return true;
                ...
                case acBandGridView.emEditorType.MEMO:
                    {
                        return true;
                ...
                case acBandGridView.emEditorType.PICTURE:
                    {
                        return true;
                ...
                case acBandGridView.emEditorType.PROGRESSBAR:
                    {
                        return true;


                    }
                case acBandGridView.emEditorType.TIME:
                    {
                        return true;
                ...
                case acBandGridView.emEditorType.TEXT:
                    {
                        if (this._EditorData is ControlManager.acBandGridView.emTextEditMask)
                        {
                            return true;
                        }
                ...
                case acBandGridView.emEditorType.CHECK:
                    {
                        ...
                        if (this._EditorData is ControlManager.acBandGridView.emCheckEditDataType)
                        {
                            return true;
                        }
                ...
                case acBandGridView.emEditorType.DATE:
                    {
                        if (this._EditorData is ControlManager.acBandGridView.emDateMask)
                        {
                            return true;
                        }
                ...
                case acBandGridView.emEditorType.DATE_STRING:
                    {
        ...
        private acBandGridView.emEditorType _EditorType = acBandGridView.emEditorType.NONE;

        public acBandGridView.emEditorType EditorType
        {
    ...
    public class acBandGridViewInfoRegistrator : GridInfoRegistrator
    {
        public override string ViewName { get { return "acBandGridView"; } }

        public override BaseView CreateView(GridControl grid)
        {
            return new acBandGridView(grid as GridControl);
        }
        public override BaseViewInfo CreateViewInfo(BaseView view)
        {
            return new acBandGridViewInfo(view as acBandGridView);
        }
    }

    public class acBandGridViewInfo : GridViewInfo
    {
        public acBandGridViewInfo(DevExpress.XtraGrid.Views.Grid.GridView gridView)
            : base(gridView)
        {
    ...
    public class acBandGridControl : GridControl, IControl
    {
        ...
        protected override void WndProc(ref Message m)
        {
            if (m.Msg == WIN32API.WM_CONTEXTMENU)
            {
                ...
                acBandGridView view = (acBandGridView)this.MainView;
        ...
        protected override void OnCreateControl()
        {
            ...
            acBandGridView view = this.MainView as acBandGridView;
            if (view != null
                ...
                if (view != null)
                {
                    ...
                    if (ControlManager.acInfo.IsRunTime == true)
                    {
                        if (this._InitLayout == false)
                        {
                            ...
                            acBandGridViewConfig systemConfig = new acBandGridViewConfig(view);
        ...
        public DataTable ConvertDataSource(DataTable dt)
        {
            ...
            if (temp != null)
            {
                ...
                foreach (acBandedGridColumn col in view.Columns)
                {
                    ...
                    else if (col.EditorType == acBandGridView.emEditorType.DATE_STRING)
                    {
                        if (temp.Columns.Contains(col.FieldName))
                        {
                            if (temp.Columns[col.FieldName].DataType != typeof(DateTime))
            ...
            catch (Exception ex)
            {
                if (ex is TargetInvocationException)
                {
                    acMessageBox.Show(acInfo.Resource.GetString("사용자 UI 데이터를 읽어올수없습니다. 새로 구성하여 저장하시기 바랍니다.", "GFX5D9VY"),
                        (((acBandGridView)this.MainView).ParentControl as IBase).Caption, acMessageBox.emMessageBoxType.CONFIRM);
        ...
        {
            return CreateView("acBandGridView");
        }
        protected override void RegisterAvailableViewsCore(InfoCollection
    collection)
        {
            base.RegisterAvailableViewsCore(collection);
            collection.Add(new acBandGridViewInfoRegistrator());
        }
        ...
        {
            (this.MainView as acBandGridView).ParentControl.Focus();
    ...
    public class acBandGridView : DevExpress.XtraGrid.Views.BandedGrid.BandedGridView
    {
        ...
        public int OldFocusRowHandle
        {
            get
            {
                acBandGridControl acGrid = (acBandGridControl)this.GridControl;
        ...
        /// 사용자 UI
        /// </summary>
        internal acBandGridViewConfig _Config = null;


        protected override GridColumnCollection CreateColumnCollection()
        {
            return new acBandedGridColumnCollection(this);
        }
        ...
        void SetGridType()
        {
            switch (this._GridType)
            {
                ...
                case ControlManager.acBandGridView.emGridType.SEARCH:
                    ...
                    break;
                case ControlManager.acBandGridView.emGridType.SEARCH_SEL:
                    ...
                    break;
                case ControlManager.acBandGridView.emGridType.FIXED:
                ...
                case ControlManager.acBandGridView.emGridType.FIXED_EXCEL:
                ...
                case ControlManager.acBandGridView.emGridType.COMMON_CONTROL:
                ...
                case ControlManager.acBandGridView.emGridType.LIST_USERCONFIG:
                ...
                case ControlManager.acBandGridView.emGridType.LIST_USERCONFIG2:
                ...
                case ControlManager.acBandGridView.emGridType.LIST:
                ...
                case ControlManager.acBandGridView.emGridType.ATTACH_FILE_LIST:
                ...
                case ControlManager.acBandGridView.emGridType.LIST_SINGLE:
                ...
                case ControlManager.acBandGridView.emGridType.AUTO_COL:
        ...
        /// 그리드 형태를 설정합니다.
        /// </summary>
        [DefaultValue(ControlManager.acBandGridView.emGridType.SEARCH)]
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        private void Init()
        {
            ...
            if (this._IsUserStyle)
            {
                ...
                this.Appearance.BandPanel.Options.UseBackColor = true;
                this.Appearance.BandPanel.BackColor = this.Appearance.HeaderPanel.BackColor;
                this.Appearance.BandPanel.Options.UseForeColor = true;
                this.Appearance.BandPanel.ForeColor = this.Appearance.HeaderPanel.ForeColor;
                this.Appearance.BandPanel.Options.UseFont = true;
                this.Appearance.BandPanel.Font = this.Appearance.HeaderPanel.Font;
            }
            ...
            if (acInfo.IsRunTime == true)
            {
                ...
                this._Config = new acBandGridViewConfig(this);
            ...
            this.Click += new EventHandler(acBandGridView_Click);

            this.MouseDown += new MouseEventHandler(acBandGridView_MouseDown);

            //this.ShowGridMenuEx += new GridMenuEventHandler(acBandGridView_ShowGridMenu);
            this.ShowGridMenuEx += new ShowGridMenuExHandler(acBandGridView_ShowGridMenuEx); ;
            
            this.PopupMenuShowing += new PopupMenuShowingEventHandler(acBandGridView_PopupMenuShowing);

            this.CustomDrawRowIndicator += new RowIndicatorCustomDrawEventHandler(acBandGridView_CustomDrawRowIndicator);

            this.CustomDrawCell += new RowCellCustomDrawEventHandler(acBandGridView_CustomDrawCell);

            this.Disposed += new EventHandler(acBandGridView_Disposed);
            ...
            this.ShowCustomizationForm += new EventHandler(acBandGridView_ShowCustomizationForm);

            this.HideCustomizationForm += new EventHandler(acBandGridView_HideCustomizationForm);

            this.DragObjectDrop += new DragObjectDropEventHandler(acBandGridView_DragObjectDrop);

            this.DragObjectStart += new DragObjectStartEventHandler(acBandGridView_DragObjectStart);

            this.DataSourceChanged += new EventHandler(acBandGridView_DataSourceChanged);

            this.CustomDrawColumnHeader += new ColumnHeaderCustomDrawEventHandler(acBandGridView_CustomDrawColumnHeader);
        }
        ...
        void acBandGridView_CustomDrawColumnHeader(object sender, ColumnHeaderCustomDrawEventArgs e)
        {
            this._ColumnHeaderHeight = e.Bounds.Height;
            this._ColumnHeaderCustomDrawEventArgs = e;
        }
        
        void acBandGridView_ShowGridMenuEx(object sender, PopupMenuShowingEventArgs e)
        {
            e.Allow = false;
        }

        private void acBandGridView_PopupMenuShowing(object sender, PopupMenuShowingEventArgs e)
        {
            e.Allow = false;
        }

        void acBandGridView_DataSourceChanged(object sender, EventArgs e)
        {
        ...
        void acBandGridView_DragObjectStart(object sender, DragObjectStartEventArgs e)
        {
            //드래그 컬럼 정보 저장

            acBandedGridColumn cln = e.DragObject as acBandedGridColumn;
        ...
        void acBandGridView_DragObjectDrop(object sender, DragObjectDropEventArgs e)
        {
            acBandedGridColumn cln = e.DragObject as acBandedGridColumn;
        ...
        void acBandGridView_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        void acBandGridView_HideCustomizationForm(object sender, EventArgs e)
        {
            this._isCustomizationForm = false;
        }

        void acBandGridView_ShowCustomizationForm(object sender, EventArgs e)
        {
        ...
        void GroupSummary_CollectionChanged(object sender, CollectionChangeEventArgs e)
        {
                ...
                e.Action == CollectionChangeAction.Refresh)
            {
                ...
                if (item != null)
                {
                    ...
                    acBandedGridColumn col = this.Columns[item.FieldName] as acBandedGridColumn;
        ...
        void acBandGridView_Disposed(object sender, EventArgs e)
        {
            if (_StyleBox != null)
            {
            ...
            foreach (KeyValuePair<string, acBandGridViewFilterEditor> filter in _FilterEditors)
            {
                filter.Value.Dispose();
            }

            foreach (KeyValuePair<string, acBandGridViewMaskEdit> mask in _MaskEditors)
            {
                mask.Value.Dispose();
            }
        ...
        void acBandGridView_CustomDrawCell(object sender, RowCellCustomDrawEventArgs e)
        {
        ...
        void acBandGridView_CustomDrawRowIndicator(object sender, RowIndicatorCustomDrawEventArgs e)
        {
        ...
        public acBandGridView(GridControl owerGridControl)
            : base(owerGridControl)
        {
            ...
            {
                this.ParentControl = owerGridControl.TopLevelControl;
            }
        }


        public acBandGridView()
            : base()
        {
            ...
            {
                this.ParentControl = this.GridControl.TopLevelControl;
            }
        }
        ...
        void menuItemEditShowTypeValue_Click(object sender, EventArgs e)
        {
            ...
            acBandedGridColumn col = (acBandedGridColumn)item.RefObject;
        ...
        private Dictionary<string, acBandGridViewFilterEditor> _FilterEditors = new Dictionary<string, acBandGridViewFilterEditor>();
        ...
        void menuItemFilter_Click(object sender, EventArgs e)
        {
            ...
            acBandedGridColumn col = (acBandedGridColumn)item.UserData;

            if (!_FilterEditors.ContainsKey(col.FieldName))
            {
                acBandGridViewFilterEditor frm = new acBandGridViewFilterEditor(this, col.FieldName);

                frm.ParentControl = new Control();

                frm.ParentControl.Name = this.ParentControl.Name + "." + this.Name;

                frm.FormClosed += new FormClosedEventHandler(acBandGridViewFilter_FormClosed);
        ...
        internal void ShowFastFilterEditor(string filedName)
        {
            ...
            {
                acBandGridViewFilterEditor frm = new acBandGridViewFilterEditor(this, filedName);
        ...
        void acBandGridViewFilter_FormClosed(object sender, FormClosedEventArgs e)
        {
            //acBandGridViewFilterEditor frm = (acBandGridViewFilterEditor)sender;
        ...
        internal void HideSubWindows()
        {
            ...
            foreach (KeyValuePair<string, acBandGridViewMaskEdit> maskEditor in this._MaskEditors)
            {
            ...
            foreach (KeyValuePair<string, acBandGridViewFilterEditor> filterEditor in this._FilterEditors)
            {
        ...
        {
            acBandGridViewConfig systemConfig = new acBandGridViewConfig(this);

            acBandGridControl acGridControl = (acBandGridControl)this.GridControl;
        ...
        public void ResetUserConfig(string className, string controlName, string userID)
        {
            ...
            acBandGridControl acGrid = this.GridControl as acBandGridControl;
        ...
        {
            acBandGridControl grid = (this.GridControl as acBandGridControl);
        ...
        public void LoadUserConfig()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    acMessageBox.Show(acInfo.Resource.GetString("사용자 UI 데이터를 읽어올수없습니다. 새로 구성하여 저장하시기 바랍니다.", "GFX5D9VY"),
                        (((acBandGridView)this).ParentControl as IBase).Caption, acMessageBox.emMessageBoxType.CONFIRM);
        ...
        private Dictionary<string, acBandGridViewMaskEdit> _MaskEditors = new Dictionary<string, acBandGridViewMaskEdit>();
        ...
        void menuItemMask_Click(object sender, EventArgs e)
        {
            ...
            {
                acBandGridViewMaskEdit frm = new acBandGridViewMaskEdit(col);
        ...
        {
            //acBandGridViewMaskEdit frm = (acBandGridViewMaskEdit)sender;
        ...
        private acBandGridViewUserConfigManager _ConfigManager = null;
        ...
        void menuItemConfigManager_Click(object sender, EventArgs e)
        {
            ...
            if (_ConfigManager == null)
            {
                _ConfigManager = new acBandGridViewUserConfigManager(this);
        ...
        acBandGridViewUserConfigLoadEditor _LoadConfig = null;
        ...
        void menuItemConfigLoad_Click(object sender, EventArgs e)
        {
            ...
            if (this._LoadConfig == null)
            {
                _LoadConfig = new acBandGridViewUserConfigLoadEditor(this);
        ...
        {
            acBandGridViewUserConfigSaveEditor frm = new acBandGridViewUserConfigSaveEditor(this);
        ...
        void menuItemSystemConfig_Click(object sender, EventArgs e)
        {
            ...
            acBandGridControl acData = (acBandGridControl)this.GridControl;
        ...
        acBandGridViewStyleBox _StyleBox = null;
        ...
        void menuItemStyleBox_Click(object sender, EventArgs e)
        {
            ...
            if (this._StyleBox == null)
            {
                ...
                _StyleBox = new acBandGridViewStyleBox(this);
        ...
        //                //데이터컬럼 타입에 따른 변환
        //                acBandedGridColumn col = (acBandedGridColumn)this.Columns[keyColumn];
        ...
        private void ConvertColumnType(DataTable dt)
        {
            ...
            {
                acBandedGridColumn acCol = (acBandedGridColumn)this.Columns[col.ColumnName];

                if (acCol != null)
                {

                    if (acCol.EditorType == acBandGridView.emEditorType.DATE)
                    {
                    ...
                    else if (acCol.EditorType == acBandGridView.emEditorType.LOOKUP_CODE)
                    {
                ...
                for (int i = 0; i < view.Count; i++)
                {
                    ...
                    if (isFindRow == true)
                    {
                        ...
                        foreach (DataColumn col in rowView.Row.Table.Columns)
                        {
                            ...
                            {
                                if (view.Table.Columns[col.ColumnName].DataType == typeof(DateTime))
                                {
                                    viewRow[col.ColumnName] = row[col.ColumnName].toDateTimeDBNull();
                                }
                                else
                                {
        ...
        public bool ValidCheck(string filter)
        {
            ...
            foreach (acBandedGridColumn col in this.Columns)
            {
        ...
        public DataView GetFilteredDataView()
        {
            if (this.GridControl.DataSource == null)
            {
                this.GridControl.DataSource = this.DefaultTable;
            ...
            return this.GetFilterdData(this.GridControl);
        }

        private DataView GetFilterdData(GridControl gc)
        {
            ...
            if (gc.FocusedView != null && gc.FocusedView.DataSource != null)
            {
                ...
                filteredDataView.Sort = sortExpression;
        ...
        void acBandGridView_Click(object sender, EventArgs e)
        {
            ...
            if (this._MouseDownArgs != null)
            {
                ...
                if (hintInfo.HitTest == GridHitTest.Column)
                {
                    ...
                    acBandedGridColumn acCol = hintInfo.Column as acBandedGridColumn;
        ...
        {
            acBandedGridColumn col = new acBandedGridColumn();
        ...
        public void AddDateEdit(string columnName, string caption, string resourceID, bool useReSourceID, HorzAlignment align, bool allowEdit, bool visible, bool isRequired, string mask, string ctr = null)
        {
            AddDateEdit(columnName, caption, resourceID, useReSourceID, align, allowEdit, visible, isRequired, mask, caption, ctr);
        }

        public void AddDateEdit(string columnName, string caption, string resourceID, bool useReSourceID, HorzAlignment align, bool allowEdit, bool visible, bool isRequired, string mask,string bandCaption, string ctr = null)
        {
            acBandedGridColumn col = new acBandedGridColumn();
        ...
        {
            AddDateEdit(columnName, caption, resourceID, useReSourceID, align, allowEdit, visible, isRequired, dateMask, caption);
        }

        public void AddDateEdit(string columnName, string caption, string resourceID, bool useReSourceID, HorzAlignment align, bool allowEdit, bool visible, bool isRequired, emDateMask dateMask, string bandCaption)
        {
            acBandedGridColumn col = new acBandedGridColumn();
            ...
            switch (dateMask)
            {
                ...
                case emDateMask.MEDIUM_DATE3:

                    dateEdit.Mask.EditMask = "MM-dd HH:mm";
        ...
        {
            AddProgressBar(columnName, caption, resourceID, useReSourceID, align, allowEdit, visible, caption);
        }

        public void AddProgressBar(string columnName, string caption, string resourceID, bool useReSourceID, HorzAlignment align, bool allowEdit, bool visible, string bandCaption)
        {
    ...
    string catCode)
        {
            AddLookUpEdit(columnName, caption, resourceID, useReSourceID, align, allowEdit, visible, isRequired, catCode, caption);
        }
    ...
    DataTable dt)
        {
            AddLookUpEdit(columnName, caption, resourceID, useReSourceID, align, allowEdit, visible, isRequired, dt, caption);
        }
    ...
    DataTable dt, string bandCaption)
        ...
        {
            this.AddLookUpVendor(columnName, caption, resourceID, useReSourceID, align, allowEdit, visible, isRequired, caption);
        }

        public void AddLookUpVendor(string columnName, string caption, string resourceID, bool useReSourceID, HorzAlignment align, bool allowEdit, bool visible, bool isRequired, string bandCaption)
        {
            acBandedGridColumn col = new acBandedGridColumn();
        ...
        public void AddLookUpOrg(string columnName, string caption, string resourceID, bool useReSourceID, HorzAlignment align, bool allowEdit, bool visible, bool isRequired, string bandCaption)
        {
            acBandedGridColumn col = new acBandedGridColumn();
        ...
        public void AddLookUpPart(string columnName, string caption, HorzAlignment align, bool allowEdit, bool visible, bool isRequired, string bandCaption = null)
        {
            if (bandCaption == null)
            {
                bandCaption = caption;
        ...
        GridBand SetAddBands(GridBandCollection bands, string[] bandsCaption, int index, bool visible)
        {
            GridBand band = null;

            for (int i = 0; i < bands.Count; i++)
            {
                if (bands[i].Caption == bandsCaption[index].toStringEmpty())
                {
                    band = bands[i];
                    //return band;
                    //break;
            ...
            {
                band = new GridBand();
                band.Caption = bandsCaption[index];
                band.AppearanceHeader.Options.UseTextOptions = true;
                band.AppearanceHeader.TextOptions.HAlignment = HorzAlignment.Center;
                band.AppearanceHeader.TextOptions.VAlignment = VertAlignment.Center;
            ...
            if (bandsCaption.GetUpperBound(0) == index)
            {
                return band;
            }

            return SetAddBands(band.Children,bandsCaption, ++index, visible);
        }
    ...
    string displayColumnName, string valueColumnName, object dataSource)
        {
            AddLookUpEdit(columnName, caption, resourceID, useReSourceID, align, allowEdit, visible, isRequired, displayColumnName, valueColumnName, dataSource, caption);
        }

        public void AddLookUpEdit(string columnName, string caption, string resourceID, bool useReSourceID, HorzAlignment align, bool allowEdit, bool visible, bool isRequired,
    string displayColumnName, string valueColumnName, string ruleName)
        {
            DataTable paramTable = new DataTable("RQSTDT");
            paramTable.Columns.Add("PLT_CODE", typeof(String)); //
            DataRow paramRow = paramTable.NewRow();
            ...
            {
                DataSet resultSet = BizRun.QBizRun.ExecuteService(this, strParam[0],ruleName, paramSet, "RQSTDT", "RSLTDT");
                if (resultSet.Tables.Count > 0)
                {
                    AddLookUpEdit(columnName, caption, resourceID, useReSourceID, align, allowEdit, visible, isRequired, displayColumnName, valueColumnName, resultSet.Tables["RSLTDT"], caption);
                }
            }
        }
    ...
    string displayColumnName, string valueColumnName, object dataSource, string bandCaption)
        ...
        {
            AddCheckEdit(columnName, caption, resourceID, useReSourceID, allowEdit, visible, chekEditDataType, caption, CheckStyles.Style1);
        }

        public void AddCheckEdit(string columnName, string caption, string resourceID, bool useReSourceID, bool allowEdit, bool visible, emCheckEditDataType chekEditDataType, string bandCaption)
        {
            AddCheckEdit(columnName, caption, resourceID, useReSourceID, allowEdit, visible, chekEditDataType, bandCaption, CheckStyles.Style4);
        }

        public void AddCheckEdit(string columnName, string caption, string resourceID, bool useReSourceID, bool allowEdit, bool visible, emCheckEditDataType chekEditDataType,  CheckStyles checkStyle)
        {
            AddCheckEdit(columnName, caption, resourceID, useReSourceID, allowEdit, visible, chekEditDataType, caption, checkStyle);
        }

        public void AddCheckEdit(string columnName, string caption, string resourceID, bool useReSourceID, bool allowEdit, bool visible, emCheckEditDataType chekEditDataType,string bandCaption, CheckStyles checkStyle)
        {
            acBandedGridColumn col = new acBandedGridColumn();
            ...
            //checkItemEdit.CheckStyle = checkStyle;
            checkItemEdit.CheckStyle = CheckStyles.Standard;
            checkItemEdit.ExportMode = ExportMode.DisplayText;
            checkItemEdit.DisplayValueChecked = "■";
            checkItemEdit.DisplayValueGrayed = "□";
            checkItemEdit.DisplayValueUnchecked = "□";
        ...
        public void AddRadioButton(string columnName, string caption, string resourceID, bool useReSourceID, bool allowEdit, bool visible, emCheckEditDataType chekEditDataType)
        {
            AddRadioButton(columnName, caption, resourceID, useReSourceID, allowEdit, visible, chekEditDataType, caption);
        }

        public void AddRadioButton(string columnName, string caption, string resourceID, bool useReSourceID, bool allowEdit, bool visible, emCheckEditDataType chekEditDataType, string bandCaption)
        {
            acBandedGridColumn col = new acBandedGridColumn();
            ...
            col.EditorType = emEditorType.RADIO_BUTTON;
            ...
            checkItemEdit.CheckStyle = CheckStyles.Radio;
        ...
        void radioButton_EditValueChanging(object sender, ChangingEventArgs e)
        {
            //RadioButton edit = sender as RadioButton;
        ...
        public void AddTextEdit(string columnName, string caption, string resourceID, bool useReSourceID, HorzAlignment align, bool allowEdit, bool visible, bool isRequired, emTextEditMask mask)
        {
            AddTextEdit(columnName, caption, resourceID, useReSourceID, align, allowEdit, visible, isRequired, mask, caption);
        }

        public void AddTextEdit(string columnName, string caption, string resourceID, bool useReSourceID, HorzAlignment align, bool allowEdit, bool visible, bool isRequired, emTextEditMask mask, string[] bandCaptions)
        {
            ...
            try
            {
                ...
                GridBand gb =this.SetAddBands(this.Bands, bandCaptions, 0, col.Visible);
                gb.Columns.Add(col);
        ...
        public void AddTextEdit(string columnName, string caption, string resourceID, bool useReSourceID, HorzAlignment align, bool allowEdit, bool visible, bool isRequired, emTextEditMask mask,string bandCaption)
        {
        ...
        public void AddTextEdit(string columnName, string caption, string resourceID, bool useReSourceID, HorzAlignment align, bool allowEdit, bool visible, bool isRequired, emTextEditMask mask, GridBand parentBand)
        {
        ...
        {
            AddCheckedComboBoxEdit(columnName, caption, resourceID, useReSourceID, align, allowEdit, visible, isRequired, "CD_NAME", "CD_CODE", acInfo.StdCodes.GetCatTable(catcode), caption);
        }

        public void AddCheckedComboBoxEdit(string columnName, string caption, string resourceID, bool useReSourceID,
            HorzAlignment align, bool allowEdit, bool visible, bool isRequired, string catcode, string bandCaption)
        {
            AddCheckedComboBoxEdit(columnName, caption, resourceID, useReSourceID, align, allowEdit, visible, isRequired, "CD_NAME", "CD_CODE", acInfo.StdCodes.GetCatTable(catcode), bandCaption);
        }
        public void AddCheckedComboBoxEdit(string columnName, string caption, string resourceID, bool useReSourceID,
            HorzAlignment align, bool allowEdit, bool visible, bool isRequired, string displayColumnName, string valueColumnName, object dataSource, string bandCaption)
        {
        ...
        void TextEdit_EditValueChanging(object sender, ChangingEventArgs e)
        {
            ...
            if (editor.Tag != null)
            {
                if (editor.Tag is RepositoryItem)
                {
                    ...
                    acBandedGridColumn col = item.Tag as acBandedGridColumn;
        ...
        private void SetGridColumnMenu(GridViewMenu menu, GridHitInfo hitInfo)
        {
            ...
            if (hitInfo.HitTest == GridHitTest.Column || hitInfo.HitTest == GridHitTest.ColumnPanel)// || hitInfo.HitTest == GridHitTest.RowDetail)
            {

                acBandedGridColumn acCol = (acBandedGridColumn)hitInfo.Column;
