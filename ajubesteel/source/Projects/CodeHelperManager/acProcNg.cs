...
{
    public class acProcNgInstantResult
    {
    ...
    public class RepositoryItemProcNg : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemProcNg()
        {
            Register();
        }


        public RepositoryItemProcNg()
        {
            base.Buttons.Clear();
        ...
        internal const string EditorName = "acProcNg";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acProcNg),
                typeof(RepositoryItemProcNg), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acProcNg : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        public acProcNg()
        {
            ...
            {
                acProcNg.SetPopupGridView(acGridView1);
   
            }

  
            acGridView1.OnInitLayout += new acGridView.InitLayoutEventHandler(acGridView1_OnInitLayout);
            this.CloseUp +=new CloseUpEventHandler(acProcNg_CloseUp);
            this.Popup += new EventHandler(acProcNg_Popup);
            this.QuickFindEditor.KeyDown += new KeyEventHandler(QuickFindEditor_KeyDown);


            this.GotFocus += new EventHandler(acProcNg_GotFocus);
            this.LostFocus += new EventHandler(acProcNg_LostFocus);

        }

        void acProcNg_GotFocus(object sender, EventArgs e)
        {
        ...
        void acProcNg_LostFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
                this.SetStyle();
        ...
        {
            //기본컬럼
            view.AddTextEdit("NG_ID", "불량번호", "16SQP5J9", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
        ...
        void acProcNg_CloseUp(object sender, CloseUpEventArgs e)
        {
            QuickFindEditor.EditValue = null;
        }

        void acProcNg_Popup(object sender, EventArgs e)
        {
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acProcNg", acInfo.DefaultConfigUser);
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemProcNg.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemProcNg Properties
        {
            get
            {

                return base.Properties as RepositoryItemProcNg;
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acProcNgForm frmFind = new acProcNgForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["NG_ID"]))
                {
                ...
                this._Value = result.Rows[0]["NG_ID"];



                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_PROC_NG_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript( acInfo.SysConfig.GetSysConfigByMemory("CTRL_PROC_NG_SHOW_COLUMN"));
        ...
        public static acProcNgInstantResult ShowInstantForm(Control parent,  string caption)
        {
            acProcNgForm frmFind = new acProcNgForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                return new acProcNgInstantResult() { OutputData = result.Rows[0], DialogResult = DialogResult.OK };
            }


            return new acProcNgInstantResult() { OutputData = null, DialogResult = DialogResult.Cancel };
        ...
        public static DataRow GetDataRow(object code)
        {
            ...
            paramTable.Columns.Add("NG_ID", typeof(String)); //부품코드
            ...
            DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(), "CONTROL_PROC_NG_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
        ...
        private bool SetCode(object code)
        {
            ...
            if (acChecker.isNull(code) == false)
            {
                ...
                DataTable result = BizRun.QBizRun.ExecuteService(this, "CONTROL_PROC_NG_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
