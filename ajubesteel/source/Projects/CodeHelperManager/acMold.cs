...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemMold : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemMold()
        {
            Register();
        }


        public RepositoryItemMold()
        {
            base.Buttons.Clear();
        ...
        internal const string EditorName = "acMold"; 

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acMold),
                typeof(RepositoryItemMold), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acMold : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        public acMold()
        {
            ...
            {
                acMold.SetPopupGridView(acGridView1);
   
            }

  
            acGridView1.OnInitLayout += new acGridView.InitLayoutEventHandler(acGridView1_OnInitLayout);
            this.CloseUp +=new CloseUpEventHandler(acMold_CloseUp);
            this.Popup += new EventHandler(acMold_Popup);
            this.QuickFindEditor.KeyDown += new KeyEventHandler(QuickFindEditor_KeyDown);

            this.GotFocus += new EventHandler(acMold_GotFocus);
            this.LostFocus += new EventHandler(acMold_LostFocus);

        }

        void acMold_LostFocus(object sender, EventArgs e)
        {
        ...
        void acMold_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        public static void SetPopupGridView(acGridView view)
        {
            ...
            view.AddTextEdit("MOLD_CODE", "금형코드", "NZ2K4MWY", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            view.AddTextEdit("MODEL", "Model Name", "KH7K1W1F", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            ...
            view.AddTextEdit("PROD_NAME", "제품명", "40901", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            ...
            view.AddTextEdit("ACC_SHOT", "누적SHOT", "40723", false, DevExpress.Utils.HorzAlignment.Far, false, true, false, acGridView.emTextEditMask.NONE);
            view.AddTextEdit("MOLD_NO", "차수", "C3O121LD", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("MOLD_EMP", "담당자코드", "42388", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("MOLD_EMP_NAME", "담당자", "40127", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);

            view.AddDateEdit("PROD_DATE", "제작일", "50272", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emDateMask.SHORT_DATE);

            view.AddTextEdit("PROD_VND", "제작처코드", "42385", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("PROD_VND_NAME", "제작처", "40840", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);

            view.AddDateEdit("BALJU_DATE", "발주일", "40206", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emDateMask.SHORT_DATE);

            view.AddTextEdit("BALJU_VND", "발주처코드", "42503", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("BALJU_VND_NAME", "발주처", "42504", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("SCOMMENT", "비고", "ARYZ726K", true, DevExpress.Utils.HorzAlignment.Near, false, true, false, acGridView.emTextEditMask.NONE);

        }


        void acMold_CloseUp(object sender, CloseUpEventArgs e)
        {
            QuickFindEditor.EditValue = null;
        }

        void acMold_Popup(object sender, EventArgs e)
        {
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acMold", acInfo.DefaultConfigUser);
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemMold.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemMold Properties
        {
            get
            {

                return base.Properties as RepositoryItemMold;
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acMoldForm frmFind = new acMoldForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["MOLD_CODE"]))
                {
                ...
                this._Value = result.Rows[0]["MOLD_CODE"];
