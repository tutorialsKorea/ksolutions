...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemProject : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemProject()
        {
            Register();
        }


        public RepositoryItemProject()
        {
            base.Buttons.Clear();
        ...
        internal const string EditorName = "acProject";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acProject),
                typeof(RepositoryItemProject), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acProject : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        static acProject()
        {
            RepositoryItemProject.Register();
        }
        ...
        public acProject()
        {
            ...
            {
                acProject.SetPopupGridView(acGridView1);
            }


            this.CloseUp += new CloseUpEventHandler(acProject_CloseUp);
            this.Popup += new EventHandler(acProject_Popup);
            ...
            this.GotFocus += new EventHandler(acProject_GotFocus);
            this.LostFocus += new EventHandler(acProject_LostFocus);

        }

        void acProject_LostFocus(object sender, EventArgs e)
        {
        ...
        void acProject_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        public static void SetPopupGridView(acGridView view)
        {
            ...
            //기본컬럼
            view.AddTextEdit("PRJ_CODE", "모델코드", "40171", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            view.AddTextEdit("PRJ_NAME", "모델명", "40175", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
        ...
        void acProject_CloseUp(object sender, CloseUpEventArgs e)
        {
            QuickFindEditor.EditValue = null;
        }

        void acProject_Popup(object sender, EventArgs e)
        {
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acProject", acInfo.DefaultConfigUser);
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemProject.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemProject Properties
        {
            get
            {

                return base.Properties as RepositoryItemProject;
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acProjectForm frmFind = new acProjectForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["PRJ_CODE"]))
                {
                ...
                this._Value = result.Rows[0]["PRJ_CODE"];





                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_PRJ_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_PRJ_SHOW_COLUMN"));
        ...
        public static DataRow GetDataRow(object code)
        {
            ...
            paramTable.Columns.Add("PRJ_CODE", typeof(String)); //부품코드

            DataRow paramRow = paramTable.NewRow();
            paramRow["PLT_CODE"] = acInfo.PLT_CODE;
            paramRow["PRJ_CODE"] = code;
            paramTable.Rows.Add(paramRow);
            DataSet paramSet = new DataSet();
            paramSet.Tables.Add(paramTable);

            //DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(), "CONTROL_PRJ_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];

            DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(), "CTRL", "CONTROL_PRJ_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
        ...
        private bool SetCode(object code)
        {
            ...
            if (acChecker.isNull(code) == false)
            {
                ...
                //DataTable result = BizRun.QBizRun.ExecuteService(this, "CONTROL_PRJ_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];

                DataTable result = BizRun.QBizRun.ExecuteService(GetClassName(), "CTRL", "CONTROL_PRJ_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
