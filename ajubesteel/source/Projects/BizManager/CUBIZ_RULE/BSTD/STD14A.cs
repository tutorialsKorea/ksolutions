...
namespace BSTD
{
    public class STD14A
    {
        ...
        public static DataSet STD14A_INS(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
                ...
                return STD14A_SER(paramDS, bizExecute);
            }
            catch (Exception ex)
            {
        ...
        /// <param name="paramDS"></param>
        /// <returns></returns>
        public static DataSet STD14A_INS2(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {                          
                foreach (DataRow row in paramDS.Tables["RQSTDT"].Rows)
                {
                    ...
                    if (dtRsltCat.Rows.Count > 0)
                    {
                        if (object.Equals(dtRsltCat.Rows[0]["IS_FIXED_CD"], (byte)1))
                        {
                            ...
                            DataTable dtEmp = DSTD.TSTD_EMPLOYEE.TSTD_EMPLOYEE_SER(bizExecute);
                            ...
                            {
                                throw UTIL.SetException("사용자 정보를 찾을 수 없습니다."
                                    , new System.Diagnostics.StackFrame().GetMethod().Name);
                            }
                ...
                return STD14A_SER2(paramDS, bizExecute);
            }
            catch (Exception ex)
            {
                throw UTIL.SetException(ex, new System.Diagnostics.StackFrame().GetMethod().Name);         
        ...
        /// <param name="paramDS"></param>
        /// <returns></returns>
        public static DataSet STD14A_SER(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
                UTIL.SetBizAddColumnToValue(paramDS.Tables["RQSTDT"], "DATA_FLAG", 0, typeof(Byte));

                DataTable dtRslt = DSYS.TSYS_CODECAT_QUERY.TSYS_CODECAT_QUERY2(paramDS.Tables["RQSTDT"],  bizExecute);
        ...
        public static DataSet STD14A_SER2(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
                UTIL.SetBizAddColumnToValue(paramDS.Tables["RQSTDT"], "DATA_FLAG", 0, typeof(Byte));
        ...
        /// <param name="paramDS"></param>
        /// <returns></returns>
        public static DataSet STD14A_DEL(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {                     
        ...
        /// </summary>
        /// <param name="paramDS"></param>
        public static DataSet STD14A_DEL2(DataSet paramDS, BizExecute.BizExecute bizExecute)
        {
            try
            {
