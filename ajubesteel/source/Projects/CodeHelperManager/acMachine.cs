...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemMachine : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemMachine()
        {
            Register();
        }


        public RepositoryItemMachine()
        {
            base.Buttons.Clear();
        ...
        internal const string EditorName = "acMachine";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acMachine),
                typeof(RepositoryItemMachine), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acMachine : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {

        private object _AVAILEMP = null;


        private string _parentMcCode;

        public string PARENT_MC_CODE
        {
            get
            {
                return _parentMcCode;
            }
            set
            {
                _parentMcCode = value;
        ...
        public object AVAILEMP
        {
            get { return _AVAILEMP; }
        ...
        private object _PROC_CODE = null;
        ...
        static acMachine()
        {
            RepositoryItemMachine.Register();
        }
        ...
        public acMachine()
        {
            ...
            if (ControlManager.acInfo.IsRunTime == true)
            {
                ...
                acMachine.SetPopupGridView(acGridView1);
            ...
            this.CloseUp += new CloseUpEventHandler(acMachine_CloseUp);
            this.Popup += new EventHandler(acMachine_Popup);
            ...
            this.GotFocus += new EventHandler(acMachine_GotFocus);
            this.LostFocus += new EventHandler(acMachine_LostFocus);

        }

        void acMachine_LostFocus(object sender, EventArgs e)
        {
        ...
        void acMachine_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        {
            //기본컬럼
            view.AddTextEdit("MC_CODE", "설비코드", "41162", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            view.AddTextEdit("MC_NAME", "설비명", "41202", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);


            //옵션 컬럼
            view.AddTextEdit("MC_MODEL", "실모델명", "40400", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);
            view.AddLookUpEdit("MC_GROUP", "설비그룹", "40308", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, "C020");

            view.AddDateEdit("MC_OPEN_DATE", "유효시작일", "40477", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emDateMask.SHORT_DATE);

            view.AddDateEdit("MC_CLOSE_DATE", "유효종료일", "40478", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emDateMask.SHORT_DATE);

            view.AddTextEdit("MC_SEQ", "표시순서", "40723", true , DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.NONE);



            view.AddTextEdit("CPROC_CODE", "임률코드", "0BXLGNK0", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("CPROC_NAME", "임률명", "PQB42PSL", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);


            view.AddTextEdit("MAIN_EMP", "담당자코드", "42388", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("MAIN_EMP_NAME", "담당자", "40127", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acMachine", acInfo.DefaultConfigUser);
        ...
        void acMachine_CloseUp(object sender, CloseUpEventArgs e)
        {
            QuickFindEditor.EditValue = null;
        }

        void acMachine_Popup(object sender, EventArgs e)
        {
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemMachine.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemMachine Properties
        {
            get
            {

                return base.Properties as RepositoryItemMachine;
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acMachineForm frmFind = new acMachineForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["MC_CODE"]))
                {
                ...
                this._Value = result.Rows[0]["MC_CODE"];



                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_MACHINE_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_MACHINE_SHOW_COLUMN"));
        ...
        public static DataTable GetData()
        {
            ...
            DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(), "CTRL","CONTROL_MACHINE_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
        ...
        public static object GetCodeByName(object name)
        {
            ...
            paramTable.Columns.Add("MC_NAME", typeof(String)); //부품코드

            DataRow paramRow = paramTable.NewRow();
            paramRow["PLT_CODE"] = acInfo.PLT_CODE;
            paramRow["MC_NAME"] = name;
            paramTable.Rows.Add(paramRow);
            DataSet paramSet = new DataSet();
            paramSet.Tables.Add(paramTable);
        ...
        public static DataRow GetDataRow(object code)
        {
            ...
            DataTable paramTable = new DataTable("RQSTDT");
            paramTable.Columns.Add("PLT_CODE", typeof(String)); //사업장코드
            paramTable.Columns.Add("MC_CODE", typeof(String)); //부품코드

            DataRow paramRow = paramTable.NewRow();
            paramRow["PLT_CODE"] = acInfo.PLT_CODE;
            paramRow["MC_CODE"] = code;
            paramTable.Rows.Add(paramRow);
            DataSet paramSet = new DataSet();
            paramSet.Tables.Add(paramTable);
        ...
        /// <returns></returns>
        public static DataTable GetAvailMcByEmp(object empCode)
        {
            ...
            DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(), "CTRL", "CONTROL_MACHINE_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables["RSLTDT"];
        ...
        /// <param name="procCode"></param>
        /// <returns></returns>
        public static DataTable GetAvailMcByProc(object procCode)
        {
            ...
            DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(), "CTRL", "CONTROL_AVAILMACHINE_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables["RSLTDT"];
        ...
        private bool SetCode(object code)
        {
            ...
            if (acChecker.isNull(code) == false)
            {
                ...
                DataTable result = BizRun.QBizRun.ExecuteService(this, "CTRL", "CONTROL_MACHINE_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
