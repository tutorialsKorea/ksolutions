...
namespace SYS
{
    public sealed partial class SYS17B_M0A : BaseMenu
    {
        ...
        public SYS17B_M0A()
        {
            ...
            // this.Load += SYS17B_M0A_Load;

        }
          

        //void SYS17B_M0A_Load(object sender, EventArgs e)
        //{
        //    this.Search();
        //}
                ...
                if (e.Button == MouseButtons.Left && e.Clicks == 2)
                {
                    ...
                    if (focusRow != null)
                    {
                        if (!base.ChildFormContains(focusRow["MEETING_ID"]))
                        {
                            ...
                            SYS17B_D2A frm = new SYS17B_D2A(childView as acGridView, focusRow);
        ...
        private void acBarButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (!base.ChildFormContains(focusRow["MEETING_ID"]))
                {
                    ...
                    SYS17B_D0A frm = new SYS17B_D0A(acGridView1, focusRow);
        ...
        private void acBarButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    SYS17B_D0A frm = new SYS17B_D0A(acGridView1, null);
        ...
        private void acBarButtonItem5_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                if (!base.ChildFormContains(focusRow["MEETING_ID"]))
                {
                    ...
                    SYS17B_D1A frm = new SYS17B_D1A(acGridView1, focusRow);
