...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemMenuList : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemMenuList()
        {
            Register();
        }


        public RepositoryItemMenuList()
        {
            base.Buttons.Clear();
        ...
        internal const string EditorName = "acMenuList";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acMenuList),
                typeof(RepositoryItemMenuList), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acMenuList : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        static acMenuList()
        {
            RepositoryItemMenuList.Register();
        }
        ...
        public acMenuList()
        {
            ...
            if (ControlManager.acInfo.IsRunTime == true)
            {
                ...
                acMenuList.SetPopupGridView(acGridView1);
            ...
            this.GotFocus += new EventHandler(acMenuList_GotFocus);
            this.LostFocus += new EventHandler(acMenuList_LostFocus);

        }

        void acMenuList_LostFocus(object sender, EventArgs e)
        {
        ...
        void acMenuList_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        public static void SetPopupGridView(acGridView view)
        {
            ...
            view.AddTextEdit("MENU_CODE", "메뉴코드", "C8PZLBQT", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            view.AddTextEdit("MENU_NAME", "메뉴명", "D6UJPZ3J", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acMenuList", acInfo.DefaultConfigUser);
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemMenuList.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemMenuList Properties
        {
            get
            {

                return base.Properties as RepositoryItemMenuList;
        ...
        /// <returns></returns>
        public static bool IsUse(object code)
        {
            ...
            paramRow["MENU_CODE"] = code;
            paramTable.Rows.Add(paramRow);
            DataSet paramSet = new DataSet();
            paramSet.Tables.Add(paramTable);

            DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(),"CTRL", "CONTROL_MENU_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
        ...
        /// <param name="code"></param>
        /// <returns></returns>
        public static bool IsMenuAuthority(object code)
        {
            DataTable paramTable = new DataTable("RQSTDT");
            ...
            DataSet resultSet = BizRun.QBizRun.ExecuteService(GetClassName(), "CTRL", "GET_MENU_AUTHORITY", paramSet, "RQSTDT", "RSLTDT");

            int result = resultSet.Tables["RSLTDT"].Rows[0]["RESULT"].toInt();
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acMenuListForm frmFind = new acMenuListForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["MENU_CODE"]))
                {
                ...
                this._Value = result.Rows[0]["MENU_CODE"];



                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_MENU_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_MENU_SHOW_COLUMN"));
        ...
        private bool SetCode(object code)
        {
            ...
            if (acChecker.isNull(code) == false)
            {
                ...
                DataTable result = BizRun.QBizRun.ExecuteService(this, "CTRL", "CONTROL_MENU_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
