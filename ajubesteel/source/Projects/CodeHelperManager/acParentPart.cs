...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemParentPart : RepositoryItemPopupContainerEdit
    {

        static RepositoryItemParentPart()
        {
            Register();
        }


        public RepositoryItemParentPart()
        {
            base.Buttons.Clear();
        ...
        internal const string EditorName = "acParentPart";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acParentPart),
                typeof(RepositoryItemParentPart), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acParentPart : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        static acParentPart()
        {
            RepositoryItemParentPart.Register();
        }
        ...
        public acParentPart()
        {
            ...
            {
                acParentPart.SetPopupGridView(acGridView1);
            ...
            this.GotFocus += new EventHandler(acParentPart_GotFocus);
            this.LostFocus += new EventHandler(acParentPart_LostFocus);

        }

        void acParentPart_LostFocus(object sender, EventArgs e)
        {
        ...
        void acParentPart_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acParentPart", acInfo.DefaultConfigUser);
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemParentPart.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemParentPart Properties
        {
            get
            {

                return base.Properties as RepositoryItemParentPart;
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acParentPartForm frmFind = new acParentPartForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_PL_PPART_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_PL_PPART_SHOW_COLUMN"));
        ...
        private bool SetCode(object code)
        {
            ...
            if (acChecker.isNull(code) == false)
            {
                ...
                DataTable result = BizRun.QBizRun.ExecuteService(this, "CONTROL_PARENTPART_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
