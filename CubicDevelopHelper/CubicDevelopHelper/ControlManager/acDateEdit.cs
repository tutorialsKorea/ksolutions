...
namespace ControlManager
{
    ...
    public class acDateEdit : DevExpress.XtraEditors.DateEdit, IBaseEditControl
    {
        ...
        //쉬는 시간 3타임 적용한 근무 시간 가져온다. 
        public static void GetManTime(DateTime st, DateTime ed, out double manTime)
        {
            ...
            {
                lunch_time += Math.Abs(acInfo.SysConfig.LUNCH_END_TIME.Subtract(acInfo.SysConfig.LUNCH_START_TIME).TotalMinutes);
            ...
            {
                lunch_time += Math.Abs(edx.TimeOfDay.Subtract(acInfo.SysConfig.LUNCH_START_TIME).TotalMinutes);

            }
            else if (st.TimeOfDay <= acInfo.SysConfig.LUNCH_END_TIME && acInfo.SysConfig.LUNCH_END_TIME <= edx.TimeOfDay)
            {
                lunch_time += Math.Abs(acInfo.SysConfig.LUNCH_END_TIME.Subtract(st.TimeOfDay).TotalMinutes);
            ...
            if (st.TimeOfDay <= acInfo.SysConfig.NOR_OFF_START_TIME1 && acInfo.SysConfig.NOR_OFF_END_TIME1 <= edx.TimeOfDay)
            {
                off_time1 += Math.Abs(acInfo.SysConfig.NOR_OFF_END_TIME1.Subtract(acInfo.SysConfig.NOR_OFF_START_TIME1).TotalMinutes);

            }
            else if (st.TimeOfDay <= acInfo.SysConfig.NOR_OFF_START_TIME1 && edx.TimeOfDay <= acInfo.SysConfig.NOR_OFF_END_TIME1 && edx.TimeOfDay >= acInfo.SysConfig.NOR_OFF_START_TIME1)
            {
                off_time1 += Math.Abs(edx.TimeOfDay.Subtract(acInfo.SysConfig.NOR_OFF_START_TIME1).TotalMinutes);

            }
            else if (st.TimeOfDay <= acInfo.SysConfig.NOR_OFF_END_TIME1 && acInfo.SysConfig.NOR_OFF_END_TIME1 <= edx.TimeOfDay)
            {
                off_time1 += Math.Abs(acInfo.SysConfig.NOR_OFF_END_TIME1.Subtract(st.TimeOfDay).TotalMinutes);
            ...
            if (st.TimeOfDay <= acInfo.SysConfig.NOR_OFF_START_TIME2 && acInfo.SysConfig.NOR_OFF_END_TIME2 <= edx.TimeOfDay)
            {
                off_time2 += Math.Abs(acInfo.SysConfig.NOR_OFF_END_TIME2.Subtract(acInfo.SysConfig.NOR_OFF_START_TIME2).TotalMinutes);

            }
            else if (st.TimeOfDay <= acInfo.SysConfig.NOR_OFF_START_TIME2 && edx.TimeOfDay <= acInfo.SysConfig.NOR_OFF_END_TIME2 && edx.TimeOfDay >= acInfo.SysConfig.NOR_OFF_START_TIME2)
            {
                off_time2 += Math.Abs(edx.TimeOfDay.Subtract(acInfo.SysConfig.OFF_START_TIME).TotalMinutes);

            }
            else if (st.TimeOfDay <= acInfo.SysConfig.NOR_OFF_END_TIME2 && acInfo.SysConfig.NOR_OFF_END_TIME2 <= edx.TimeOfDay)
            {
                off_time2 += Math.Abs(acInfo.SysConfig.NOR_OFF_END_TIME2.Subtract(st.TimeOfDay).TotalMinutes);
            }


            //쉬는시간3 제외
            if (st.TimeOfDay <= acInfo.SysConfig.NOR_OFF_START_TIME3 && acInfo.SysConfig.NOR_OFF_END_TIME3 <= edx.TimeOfDay)
            {
                off_time3 += Math.Abs(acInfo.SysConfig.NOR_OFF_END_TIME3.Subtract(acInfo.SysConfig.NOR_OFF_START_TIME3).TotalMinutes);

            }
            else if (st.TimeOfDay <= acInfo.SysConfig.NOR_OFF_START_TIME3 && edx.TimeOfDay <= acInfo.SysConfig.NOR_OFF_END_TIME3 && edx.TimeOfDay >= acInfo.SysConfig.NOR_OFF_START_TIME3)
            {
                off_time3 += Math.Abs(edx.TimeOfDay.Subtract(acInfo.SysConfig.OFF_START_TIME).TotalMinutes);

            }
            else if (st.TimeOfDay <= acInfo.SysConfig.NOR_OFF_END_TIME3 && acInfo.SysConfig.NOR_OFF_END_TIME3 <= edx.TimeOfDay)
            {
                off_time3 += Math.Abs(acInfo.SysConfig.NOR_OFF_END_TIME3.Subtract(st.TimeOfDay).TotalMinutes);
            }

            TimeSpan actTime = ed.Subtract(st);


            manTime = Math.Abs(actTime.TotalMinutes) - (lunch_time + off_time1 + off_time2 + off_time3);
        ...
        //특근 쉬는 시간 2타임 적용한 근무시간 가져온다.
        public static void GetHoliManTime(DateTime st, DateTime ed, out double manTime)
        {
            ...
            if (st.TimeOfDay <= acInfo.SysConfig.HOLI_OFF_START_TIME1 && acInfo.SysConfig.HOLI_OFF_END_TIME1 <= edx.TimeOfDay)
            {
                off_time1 += Math.Abs(acInfo.SysConfig.HOLI_OFF_END_TIME1.Subtract(acInfo.SysConfig.HOLI_OFF_START_TIME1).TotalMinutes);

            }
            else if (st.TimeOfDay <= acInfo.SysConfig.HOLI_OFF_START_TIME1 && edx.TimeOfDay <= acInfo.SysConfig.HOLI_OFF_END_TIME1 && edx.TimeOfDay >= acInfo.SysConfig.HOLI_OFF_START_TIME1)
            {
                off_time1 += Math.Abs(edx.TimeOfDay.Subtract(acInfo.SysConfig.HOLI_OFF_START_TIME1).TotalMinutes);

            }
            else if (st.TimeOfDay <= acInfo.SysConfig.HOLI_OFF_END_TIME1 && acInfo.SysConfig.HOLI_OFF_END_TIME1 <= edx.TimeOfDay)
            {
                off_time1 += Math.Abs(acInfo.SysConfig.HOLI_OFF_END_TIME1.Subtract(st.TimeOfDay).TotalMinutes);
            ...
            if (st.TimeOfDay <= acInfo.SysConfig.HOLI_OFF_START_TIME2 && acInfo.SysConfig.HOLI_OFF_END_TIME2 <= edx.TimeOfDay)
            {
                off_time2 += Math.Abs(acInfo.SysConfig.HOLI_OFF_END_TIME2.Subtract(acInfo.SysConfig.HOLI_OFF_START_TIME2).TotalMinutes);

            }
            else if (st.TimeOfDay <= acInfo.SysConfig.HOLI_OFF_START_TIME2 && edx.TimeOfDay <= acInfo.SysConfig.HOLI_OFF_END_TIME2 && edx.TimeOfDay >= acInfo.SysConfig.HOLI_OFF_START_TIME2)
            {
                off_time2 += Math.Abs(edx.TimeOfDay.Subtract(acInfo.SysConfig.HOLI_OFF_START_TIME2).TotalMinutes);

            }
            else if (st.TimeOfDay <= acInfo.SysConfig.HOLI_OFF_END_TIME2 && acInfo.SysConfig.HOLI_OFF_END_TIME2 <= edx.TimeOfDay)
            {
                off_time2 += Math.Abs(acInfo.SysConfig.HOLI_OFF_END_TIME2.Subtract(st.TimeOfDay).TotalMinutes);
            }
            ...
            manTime = Math.Abs(actTime.TotalMinutes) - (off_time1 + off_time2 );
