...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemField : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemField()
        {
            Register();
        }


        public RepositoryItemField()
        {
            base.Buttons.Clear();
        ...
        internal const string EditorName = "acField";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acField),
                typeof(RepositoryItemField), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acField : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        public acField()
        {
            ...
            {
                acField.SetPopupGridView(acGridView1);
            }


            this.CloseUp += new CloseUpEventHandler(acField_CloseUp);
            this.Popup += new EventHandler(acField_Popup);
            ...
            this.GotFocus += new EventHandler(acField_GotFocus);
            this.LostFocus += new EventHandler(acField_LostFocus);

        }

        void acField_LostFocus(object sender, EventArgs e)
        {
        ...
        void acField_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        {
            //기본컬럼
            view.AddTextEdit("FIELD_CODE", "사업장코드", "", false, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            view.AddTextEdit("FIELD_NAME", "사업장명", "", false, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
        }


        void acField_CloseUp(object sender, CloseUpEventArgs e)
        {
            QuickFindEditor.EditValue = null;
        }

        void acField_Popup(object sender, EventArgs e)
        {
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acField", acInfo.DefaultConfigUser);
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemField.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemField Properties
        {
            get
            {

                return base.Properties as RepositoryItemField;
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acFieldForm frmFind = new acFieldForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["FIELD_CODE"]))
                {
                ...
                this._Value = result.Rows[0]["FIELD_CODE"];





                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_FIELD_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_FIELD_SHOW_COLUMN"));
        ...
        public static DataRow GetDataRow(object code)
        {
            ...
            paramTable.Columns.Add("FIELD_CODE", typeof(String)); //부품코드

            DataRow paramRow = paramTable.NewRow();
            paramRow["PLT_CODE"] = acInfo.PLT_CODE;
            paramRow["FIELD_CODE"] = code;
            paramTable.Rows.Add(paramRow);
            DataSet paramSet = new DataSet();
            paramSet.Tables.Add(paramTable);

            DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(), "CTRL", "CONTROL_FIELD_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
        ...
        private bool SetCode(object code)
        {
            ...
            if (acChecker.isNull(code) == false)
            {
                ...
                DataTable paramTable = new DataTable("RQSTDT");
                paramTable.Columns.Add("PLT_CODE", typeof(String)); //사업장코드
                paramTable.Columns.Add("FIELD_LIKE", typeof(String)); //작업장

                DataRow paramRow = paramTable.NewRow();
                paramRow["PLT_CODE"] = acInfo.PLT_CODE;
                paramRow["FIELD_LIKE"] = code;
                paramTable.Rows.Add(paramRow);
                DataSet paramSet = new DataSet();
                paramSet.Tables.Add(paramTable);

                DataTable result = BizRun.QBizRun.ExecuteService(GetClassName(), "CTRL", "CONTROL_FIELD_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
