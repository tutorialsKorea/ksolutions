...
namespace STD
{
    public sealed partial class STD14A_M0A : BaseMenu
    {
        ...
        public override void MenuInit()
        {
            ...
            acGridView1.AddTextEdit("CAT_CODE", "분류코드", "4O9IJCLM", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            acGridView1.AddTextEdit("CAT_NAME", "분류명", "I9J5CC12", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            acGridView1.AddCheckEdit("IS_FIXED_CD", "고정코드여부", "5X8J3FYD", true, false, true, acGridView.emCheckEditDataType._BYTE);
            acGridView1.AddTextEdit("CAT_PARENT", "상위분류코드", "H72CUIB7", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            acGridView1.AddTextEdit("CAT_PARENT_NAME", "상위분류명", "ZJX6N4BQ", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            ...
            acGridView1.KeyColumn = new string[] { "CAT_CODE" };
            ...
            acGridView2.AddTextEdit("CD_CODE", "표준코드", "YJTTPFPD", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            acGridView2.AddTextEdit("CD_NAME", "표준코드명", "40738", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            acGridView2.AddTextEdit("CD_PARENT", "상위코드", "40276", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            acGridView2.AddTextEdit("CD_PARENT_NAME", "상위코드명", "NFMBOG7Q", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            acGridView2.AddCheckEdit("IS_DEFAULT", "기본값 여부", "XKEZNBNT", true, false, true, acGridView.emCheckEditDataType._BYTE);
            acGridView2.AddTextEdit("CD_SEQ", "표시순서", "40723", true, DevExpress.Utils.HorzAlignment.Far, false, true, false, acGridView.emTextEditMask.NONE);
            acGridView2.AddTextEdit("VALUE", "값", "GJ8YAWE5", true, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
        ...
        void GetDetail()
        {
            if (acGridView1.ValidFocusRowHandle() == true)
            {
                ...
                if (focusRow != null)
                {
                    ...
                    "STD14A_SER2", paramSet, "RQSTDT", "RSLTDT",
                    QuickDetail,
                    QuickException);
                }
        ...
        void Search()
        {
            ...
            DataTable paramTable = new DataTable("RQSTDT");
            paramTable.Columns.Add("PLT_CODE", typeof(String)); //
            paramTable.Columns.Add("CAT_LIKE", typeof(String)); //

            DataRow paramRow = paramTable.NewRow();
            paramRow["PLT_CODE"] = acInfo.PLT_CODE;
            paramRow["CAT_LIKE"] = layoutRow["CAT_LIKE"];
            ...
            BizRun.QBizRun.ExecuteService(this, QBiz.emExecuteType.LOAD, "STD14A_SER", paramSet, "RQSTDT", "RSLTDT",
              QuickSearch,
              QuickException);

            //BizRun.QBizRun.ExecuteService(
            //this, QBiz.emExecuteType.LOAD,
            //"STD14A_SER", paramSet, "RQSTDT", "RSLTDT",
            //QuickSearch,
            //QuickException);
        }
        ...
        private void acBarButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (!base.ChildFormContains(focusRow["CAT_CODE"]))
                {


                    STD14A_D0A frm = new STD14A_D0A(acGridView1, focusRow);

                    frm.DialogMode = BaseMenuDialog.emDialogMode.OPEN;

                    frm.ParentControl = this;

                    base.ChildFormAdd(focusRow["CAT_CODE"], frm);

                    frm.Show(this);
                }
                else
                {
                    base.ChildFormFocus(focusRow["CAT_CODE"]);
        ...
        private void acBarButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    STD14A_D0A frm = new STD14A_D0A(acGridView1, null);

                    frm.ParentControl = this;

                    frm.DialogMode = BaseMenuDialog.emDialogMode.NEW;

                    base.ChildFormAdd("NEW_CAT", frm);
        ...
        private void acBarButtonItem3_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                BizRun.QBizRun.ExecuteService(this, QBiz.emExecuteType.DEL, "STD14A_DEL", paramSet, "RQSTDT", "RSLTDT",
              QuickDEL1,
              QuickException);
        ...
        private void EditItem()
        {
            ...
            try
            {
                ...
                {
                    STD14A_D1A frm = new STD14A_D1A(acGridView1, acGridView1.GetFocusedDataRow(), acGridView2, focusRow);
        ...
        private void AddItem()
        {
            ...
            try
            {
                if (!base.ChildFormContains("NEW_CD"))
                {
                    ...
                    STD14A_D1A frm = new STD14A_D1A(acGridView1, acGridView1.GetFocusedDataRow(), acGridView2, null);
