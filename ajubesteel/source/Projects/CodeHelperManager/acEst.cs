...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemEst : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemEst()
        {
            Register();
        }


        public RepositoryItemEst()
        {
            base.Buttons.Clear();
        ...
        internal const string EditorName = "acEst";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acEst),
                typeof(RepositoryItemEst), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acEst : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        public acEst()
        {
            ...
            {
                acEst.SetPopupGridView(acGridView1);

            }


            this.CloseUp += new CloseUpEventHandler(acEst_CloseUp);
            this.Popup += new EventHandler(acEst_Popup);
            ...
            this.GotFocus += new EventHandler(acEst_GotFocus);

            this.LostFocus += new EventHandler(acEst_LostFocus);
        }

        void acEst_LostFocus(object sender, EventArgs e)
        {
        ...
        void acEst_GotFocus(object sender, EventArgs e)
        {
        ...
        {
            //기본컬럼
            view.AddTextEdit("EST_NO", "견적번호", "42315", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            view.AddTextEdit("EST_NAME", "견적명", "42327", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);


            //옵션컬럼
            view.AddTextEdit("CVND_NAME", "견적처", "R1NZ3256", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);
            view.AddTextEdit("EST_AMT", "견적금액", "42328", true , DevExpress.Utils.HorzAlignment.Far, false, false, false, acGridView.emTextEditMask.MONEY);
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acEst", acInfo.DefaultConfigUser);
        ...
        void acEst_CloseUp(object sender, CloseUpEventArgs e)
        {
            QuickFindEditor.EditValue = null;
        }

        void acEst_Popup(object sender, EventArgs e)
        {
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemEst.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemEst Properties
        {
            get
            {

                return base.Properties as RepositoryItemEst;
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acEstForm frmFind = new acEstForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["EST_NO"]))
                {
                ...
                this._Value = result.Rows[0]["EST_NO"];



                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_EST_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_EST_SHOW_COLUMN"));
        ...
        public static DataRow GetDataRow(object code)
        {
            ...
            paramTable.Columns.Add("EST_NO", typeof(String)); //부품코드

            DataRow paramRow = paramTable.NewRow();
            paramRow["PLT_CODE"] = acInfo.PLT_CODE;
            paramRow["EST_NO"] = code;
            paramTable.Rows.Add(paramRow);
            DataSet paramSet = new DataSet();
            paramSet.Tables.Add(paramTable);

            DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(), "CONTROL_EST_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
        ...
        private bool SetCode(object code)
        {
            ...
            if (acChecker.isNull(code) == false)
            {
                ...
                DataTable paramTable = new DataTable("RQSTDT");
                paramTable.Columns.Add("PLT_CODE", typeof(String)); //사업장코드
                paramTable.Columns.Add("EST_NO", typeof(String)); //견적번호
                ...
                DataTable result = BizRun.QBizRun.ExecuteService(this, "CONTROL_EST_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
