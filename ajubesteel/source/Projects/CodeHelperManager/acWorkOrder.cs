...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemWorkOrder : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemWorkOrder()
        {
            Register();
        }


        public RepositoryItemWorkOrder()
        {
            base.Buttons.Clear();
        ...
        internal const string EditorName = "acWorkOrder";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acWorkOrder),
                typeof(RepositoryItemWorkOrder), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    /// 작업지시 컨트롤
    /// </summary>
    public class acWorkOrder : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {


        public enum emWoFlag { 미확정, 확정, 진행, 중지, 완료 };

        public emWoFlag[] FixedWoFlag = new emWoFlag[] { };
        ...
        private object _PART_NAME = null;
        ...
        static acWorkOrder()
        {
            RepositoryItemWorkOrder.Register();
        }
        ...
        public acWorkOrder()
        {
            ...
            {
                acWorkOrder.SetPopupGridView(acGridView1);
            ...
            this.CloseUp += new CloseUpEventHandler(acWorkOrder_CloseUp);
            this.Popup += new EventHandler(acWorkOrder_Popup);
            ...
            this.GotFocus += new EventHandler(acWorkOrder_GotFocus);
            this.LostFocus += new EventHandler(acWorkOrder_LostFocus);
        }

        void acWorkOrder_LostFocus(object sender, EventArgs e)
        {
        ...
        void acWorkOrder_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        {
            view.AddTextEdit("WO_NO", "작업지시번호", "40556", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("PROD_CODE", "수주번호", "40900", false, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("PROD_NAME", "모델명", "40901", false, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            ...
            view.AddTextEdit("EMP_NAME", "담당자", "40127", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);

        }

        public override string EditorTypeName
        {
            get { return RepositoryItemWorkOrder.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemWorkOrder Properties
        {
            get
            {

                return base.Properties as RepositoryItemWorkOrder;
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acWorkOrder", acInfo.DefaultConfigUser);
        ...
        void acWorkOrder_CloseUp(object sender, CloseUpEventArgs e)
        {
            QuickFindEditor.EditValue = null;
        }

        void acWorkOrder_Popup(object sender, EventArgs e)
        {
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acWorkOrderForm frmFind = new acWorkOrderForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["WO_NO"]))
                {
                ...
                this._Value = result.Rows[0]["WO_NO"];



                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_WO_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_WO_SHOW_COLUMN"));
        ...
        public static DataRow GetDataRow(object code)
        {
            ...
            paramTable.Columns.Add("WO_NO", typeof(String)); //부품코드
            ...
            DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(),"CTRL", "CONTROL_WORKORDER_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[0];
        ...
        private bool SetCode(object code)
        {
            ...
            if (acChecker.isNull(code) == false)
            {
                ...
                DataTable result = BizRun.QBizRun.ExecuteService(this, "CTRL", "CONTROL_WORKORDER_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[0];
