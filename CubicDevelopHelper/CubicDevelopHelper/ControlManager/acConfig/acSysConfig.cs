...
namespace ControlManager
{
    public class acSysConfig
    {
        ...
        public TimeSpan NOR_OFF_START_TIME1
        {
            get
            {
                if (this._sysConfigDic.ContainsKey("NOR_OFF_TIME1"))
                {
                    string[] value = this._sysConfigDic["NOR_OFF_TIME1"].Split(',');
        ...
        public TimeSpan NOR_OFF_START_TIME2
        {
            get
            {
                if (this._sysConfigDic.ContainsKey("NOR_OFF_TIME2"))
                {
                    string[] value = this._sysConfigDic["NOR_OFF_TIME2"].Split(',');
        ...
        public TimeSpan NOR_OFF_START_TIME3
        {
            get
            {
                if (this._sysConfigDic.ContainsKey("NOR_OFF_TIME3"))
                {
                    string[] value = this._sysConfigDic["NOR_OFF_TIME3"].Split(',');
        ...
        public TimeSpan NOR_OFF_END_TIME1
        {
            get
            {
                if (this._sysConfigDic.ContainsKey("NOR_OFF_TIME1"))
        ...
        public TimeSpan NOR_OFF_END_TIME2
        {
            get
            {
                if (this._sysConfigDic.ContainsKey("NOR_OFF_TIME2"))
        ...
        public TimeSpan NOR_OFF_END_TIME3
        {
            get
            {
                if (this._sysConfigDic.ContainsKey("NOR_OFF_TIME3"))
        ...
        public TimeSpan HOLI_OFF_START_TIME1
        {
            get
            {
                if (this._sysConfigDic.ContainsKey("HOL_OFF_TIME1"))
                {
                    string[] value = this._sysConfigDic["HOL_OFF_TIME1"].Split(',');
        ...
        public TimeSpan HOLI_OFF_END_TIME1
        {
            get
            {
                if (this._sysConfigDic.ContainsKey("HOL_OFF_TIME1"))
        ...
        public TimeSpan HOLI_OFF_START_TIME2
        {
            get
            {
                if (this._sysConfigDic.ContainsKey("HOL_OFF_TIME2"))
                {
                    string[] value = this._sysConfigDic["HOL_OFF_TIME2"].Split(',');
        ...
        public TimeSpan HOLI_OFF_END_TIME2
        {
            get
            {
                if (this._sysConfigDic.ContainsKey("HOL_OFF_TIME2"))
