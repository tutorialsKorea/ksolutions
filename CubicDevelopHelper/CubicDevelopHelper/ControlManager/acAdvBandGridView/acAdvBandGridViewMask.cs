...
{
    [Serializable]
    public class acAdvBandGridViewMask : ISerializable 
    {
        ...
        public acAdvBandGridViewMask(object columnEdit)
        {
        ...
        public acAdvBandGridViewMask(SerializationInfo info, StreamingContext context)
        {
