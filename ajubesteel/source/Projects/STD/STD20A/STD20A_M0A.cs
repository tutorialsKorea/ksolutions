...
namespace STD
{
    public sealed partial class STD20A_M0A : BaseMenu
    {
        ...
        void acTreeList1_CellValueChanging(object sender, DevExpress.XtraTreeList.CellValueChangedEventArgs e)
        {
            ...
            if (e.Column.FieldName == "ACC_LEVEL")
            {
                string ParentValue = e.Value.ToString();

                e.Node.SetValue("ACC_LEVEL", ParentValue);

                if (e.Node.HasChildren) // 부모노드이면
                {
                    if (acMessageBox.Show(this, "하위 메뉴 권한도 모두 변경하시겠습니까?", "", false, acMessageBox.emMessageBoxType.YESNO) == DialogResult.Yes)
                    {                    
                        SetChildnode(e.Node, ParentValue);
                    }
                }                
                
            }
            else if(e.Column.FieldName == "IS_DEFAULT_MENU")
            {
                e.Node.SetValue("IS_DEFAULT_MENU", e.Value);
            }
        ...
        void SetChildnode(TreeListNode node, string value)
        {
            try
            {
        ...
        private void acBarButtonItem3_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (!base.ChildFormContains("NEW"))
                {
                    ...
                    STD20A_D0A frm = new STD20A_D0A(acGridView1, null);
        ...
        private void acBarButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (!base.ChildFormContains(focusRow["USRGRP_CODE"]))
                {
                    ...
                    STD20A_D0A frm = new STD20A_D0A(acGridView1, focusRow);
        ...
        private void acBarButtonItem4_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                STD20A_D1A frm = new STD20A_D1A(acGridView1, focusRow);
