...
namespace Zebra.Printing
{
    ...
    public class UsbPrinterConnector : PrinterConnector
    {
        ...
        public static NameValueCollection EnumDevices(string printName = "Zebra")
        {
            return EnumDevices(true, printName);
        }

        public static NameValueCollection EnumDevices(bool presentOnly,string printName = "Zebra")
        {
            return EnumDevices(presentOnly, true, printName);
        }

        public static NameValueCollection EnumDevices(bool presentOnly, bool zebraOnly, string printName = "Zebra")
        {
            return EnumDevices(presentOnly, zebraOnly, true, printName);
        }

        public static NameValueCollection EnumDevices(bool PresentOnly, bool ZebraOnly, bool fullDetail, string printName = "Zebra")
        {
                ...
                (size <= (Marshal.SizeOf(typeof(SetupApi.SP_DEVICE_INTERFACE_DETAIL_DATA))) - sizeof(UInt32)))
                {
                    ...
                    ref devinfo))
                    {
                        ...
                        if (fullDetail)
                        {
                            ...
                            if (ZebraOnly && (!desc.Contains(printName)))
                                continue;
