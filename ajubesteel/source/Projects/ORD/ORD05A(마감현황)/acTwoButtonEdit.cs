...
namespace ORD
{
    ...
    public class RepositoryItemTwoButtonEdit : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemTwoButtonEdit()
        {
            Register();
        }


        public RepositoryItemTwoButtonEdit()
        {
            base.Buttons.Clear();

            base.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Glyph, "추가", -2, true, true, false, DevExpress.XtraEditors.ImageLocation.MiddleCenter, global::ORD.Resource.add_data_1x, new DevExpress.Utils.KeyShortcut(System.Windows.Forms.Keys.None), "", "FIND")
            ,new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Glyph, "삭제", -2, true, true, false, DevExpress.XtraEditors.ImageLocation.MiddleCenter, global::ORD.Resource.sign_remove_1x, new DevExpress.Utils.KeyShortcut(System.Windows.Forms.Keys.None), "", "FIND")});

            if (acInfo.IsRunTime == true)
            {
                base.Buttons[0].SuperTip = acInfo.ToolTip.GetToolTip("추가");
                base.Buttons[1].SuperTip = acInfo.ToolTip.GetToolTip("삭제");
            }

        }


        internal const string EditorName = "acTwoButtonEdit";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acTwoButtonEdit),
                typeof(RepositoryItemTwoButtonEdit), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acTwoButtonEdit : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {
        ...
        static acTwoButtonEdit()
        {
            RepositoryItemTwoButtonEdit.Register();
        }




        public acTwoButtonEdit()
        {
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Glyph, "", -1, true, true, false, DevExpress.XtraEditors.ImageLocation.MiddleCenter, global::ORD.Resource.add_data_1x, new DevExpress.Utils.KeyShortcut(System.Windows.Forms.Keys.None), "", "FIND")
            ,new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Glyph, "", -1, true, true, false, DevExpress.XtraEditors.ImageLocation.MiddleCenter, global::ORD.Resource.sign_remove_1x, new DevExpress.Utils.KeyShortcut(System.Windows.Forms.Keys.None), "", "FIND")});

            if (ControlManager.acInfo.IsRunTime == true)
            {
                acTwoButtonEdit.SetPopupGridView(acGridView1);

            }


            acGridView1.OnInitLayout += new acGridView.InitLayoutEventHandler(acGridView1_OnInitLayout);
            this.CloseUp += new CloseUpEventHandler(acTwoButtonEdit_CloseUp);
            this.Popup += new EventHandler(acTwoButtonEdit_Popup);
            this.QuickFindEditor.KeyDown += new KeyEventHandler(QuickFindEditor_KeyDown);

            this.GotFocus += new EventHandler(acTwoButtonEdit_GotFocus);
            this.LostFocus += new EventHandler(acTwoButtonEdit_LostFocus);


        }

        void acTwoButtonEdit_LostFocus(object sender, EventArgs e)
        {
        ...
        void acTwoButtonEdit_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        {
            //기본컬럼
            view.AddTextEdit("PROD_CODE", "수주번호", "40239", false, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            view.AddTextEdit("BILL_DATE", "발행일자", "40234", false, DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            ...
            view.AddLookUpEmp("[BILL_EMP]", "발행자", "", false, DevExpress.Utils.HorzAlignment.Center, false, true, false);
            view.AddTextEdit("MAT_MTYPE", "비고", "40630", false, DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);
            view.AddMemoEdit("SCOMMENT", "비고", "", false, DevExpress.Utils.HorzAlignment.Near, DevExpress.Utils.VertAlignment.Center, false, true, true, false);
            view.AddButtonEdit("BILL_DEL", "삭제", "40338", false, DevExpress.Utils.HorzAlignment.Center, TextEditStyles.HideTextEditor, true, true, false);
            view.AddHidden("BILL_NO", typeof(string));
        ...
        void acTwoButtonEdit_CloseUp(object sender, CloseUpEventArgs e)
        {
            QuickFindEditor.EditValue = null;
        }

        void acTwoButtonEdit_Popup(object sender, EventArgs e)
        {
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acTwoButtonEdit", acInfo.DefaultConfigUser);
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemTwoButtonEdit.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemTwoButtonEdit Properties
        {
            get
            {

                return base.Properties as RepositoryItemTwoButtonEdit;
        ...
        {
            //acTwoButtonEditForm frmFind = new acTwoButtonEditForm();
        ...
        public static string GetAutoMarginSpec(object parCode, object spec)
        {
            ...
            try
            {
                ...
                DataRow partRow = acTwoButtonEdit.GetDataRow(parCode);
        ...
        protected override void OnLoaded()
        {
            if (acInfo.IsRunTime == true)
            {
                ...
                this.Properties.Buttons[1].Image = ORD.Resource.edit_find_1x;
