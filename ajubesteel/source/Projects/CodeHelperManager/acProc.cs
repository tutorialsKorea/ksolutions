...
namespace CodeHelperManager
{
    ...
    public class RepositoryItemProc : RepositoryItemPopupContainerEdit
    {
        static RepositoryItemProc()
        {
            Register();
        }


        public RepositoryItemProc()
        {
            base.Buttons.Clear();
        ...
        internal const string EditorName = "acProc";

        public static void Register()
        {

            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(acProc),
                typeof(RepositoryItemProc), typeof(DevExpress.XtraEditors.ViewInfo.PopupContainerEditViewInfo),
    ...
    public class acProc : acUserPopupContainerEdit, ControlManager.IBaseEditControl
    {



        private object _LPROC_CODE = null;


        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public object LPROC_CODE
        {
            get { return _LPROC_CODE; }
        ...
        private object _MPROC_CODE = null;


        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public object MPROC_CODE
        {
            get { return _MPROC_CODE; }
        ...
        private int _MCLASS_FLAG = -1;


        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public int MCLASS_FLAG
        {
            get { return _MCLASS_FLAG; }
        ...
        private object _PART_CODE = null;
        ...
        public acProc()
        {
            ...
            {
                acProc.SetPopupGridView(acGridView1);

            }

            this.CloseUp += new CloseUpEventHandler(acProc_CloseUp);

            this.Popup += new EventHandler(acProc_Popup);
            ...
            this.GotFocus += new EventHandler(acProc_GotFocus);

            this.LostFocus += new EventHandler(acProc_LostFocus);
        }

        void acProc_LostFocus(object sender, EventArgs e)
        {
        ...
        void acProc_GotFocus(object sender, EventArgs e)
        {
            if (acInfo.SysConfig.GetSysConfigByMemory("FOCUS_EDIT_ENABLED").toBoolean())
            {
        ...
        public static void SetPopupGridView(acGridView view)
        {
            ...
            //기본컬럼
            view.AddTextEdit("PROC_CODE", "공정코드", "40920", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);
            view.AddTextEdit("PROC_NAME", "공정명", "40921", true , DevExpress.Utils.HorzAlignment.Center, false, true, false, acGridView.emTextEditMask.NONE);

            //옵션컬럼
            view.AddTextEdit("LPROC_NAME", "대일정", "40134", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddTextEdit("MPROC_NAME", "중일정", "40632", true , DevExpress.Utils.HorzAlignment.Center, false, false, false, acGridView.emTextEditMask.NONE);

            view.AddColorEdit("PROC_COLOR", "색상", "40281", true , DevExpress.Utils.HorzAlignment.Center, false, false);
        ...
        void acGridView1_OnInitLayout(object sender)
        {
            ...
            view.LoadUserConfig("SYS04B_M0A", "acProc", acInfo.DefaultConfigUser);
        ...
        void acProc_CloseUp(object sender, CloseUpEventArgs e)
        {
            QuickFindEditor.EditValue = null;
        }

        void acProc_Popup(object sender, EventArgs e)
        {
        ...
        public override string EditorTypeName
        {
            get { return RepositoryItemProc.EditorName; }
        }



        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new RepositoryItemProc Properties
        {
            get
            {

                return base.Properties as RepositoryItemProc;
        ...
        void Execute(emMethodType method, object parameter)
        {
            ...
            acProcForm frmFind = new acProcForm();
            ...
            if (frmFind.ShowDialog() == DialogResult.OK)
            {
                ...
                if (!this._Value.EqualsEx(result.Rows[0]["PROC_CODE"]))
                {
                ...
                this._Value = result.Rows[0]["PROC_CODE"];





                if (this.EditValue.EqualsEx(result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_PROC_SHOW_COLUMN"))))
                {
                ...
                this.EditValue = result.Rows[0].GetStringByMaskScript(acInfo.SysConfig.GetSysConfigByMemory("CTRL_PROC_SHOW_COLUMN"));
        ...
        /// <summary>
        /// 해당공정이 외주설비가 가능한지 여부를 반환합니다.
        /// </summary>
        /// <param name="code"></param>
        /// <returns></returns>
        public static bool IsOS(object code)
        {
            ...
            DataTable data = BizRun.QBizRun.ExecuteService(GetClassName(),"CTRL", "CONTROL_PROC_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
        ...
        /// <summary>
        /// 특정작업자의 가능한 공정을 알아옵니다.
        /// </summary>
        /// <returns></returns>
        public static DataTable GetAvailProcByEmp(object empCode)
        {
            ...
            DataSet resultSet = BizRun.QBizRun.ExecuteService(GetClassName(), "CTRL", "CONTROL_PROC_SEARCH", paramSet, "RQSTDT", "RSLTDT");
        ...
        public static DataRow GetDataRow(object code)
        {
            ...
            paramTable.Columns.Add("PROC_CODE", typeof(String)); //부품코드
        ...
        private bool SetCode(object code)
        {
            ...
            if (acChecker.isNull(code) == false)
            {
                ...
                DataTable result = BizRun.QBizRun.ExecuteService(this, "CTRL", "CONTROL_PROC_SEARCH", paramSet, "RQSTDT", "RSLTDT").Tables[1];
